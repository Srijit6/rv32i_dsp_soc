module soc_top (clk,
 ...
 sky130_fd_sc_hd__inv_2 _3062_ (.A(net397),
 ...
 sky130_fd_sc_hd__inv_2 _3064_ (.A(\core.u_regfile.registers[2][19] ),
    .Y(_1921_));
 sky130_fd_sc_hd__and2_4 _3065_ (.A(net206),
    .B(net198),
    .X(_1932_));
 sky130_fd_sc_hd__and3_1 _3066_ (.A(net283),
    .B(net175),
 ...
 sky130_fd_sc_hd__and2_1 _3067_ (.A(net208),
    .B(net203),
    .X(_1954_));
 sky130_fd_sc_hd__and3_1 _3068_ (.A(net283),
    .B(net204),
    .C(net167),
    .X(_1965_));
 ...
 sky130_fd_sc_hd__and2_1 _3073_ (.A(net215),
    .B(net172),
    .X(_2019_));
 sky130_fd_sc_hd__nand2_2 _3074_ (.A(net199),
    .B(net95),
    .Y(_2030_));
 ...
 sky130_fd_sc_hd__o21ai_1 _3076_ (.A1(_2030_),
    ...
    .B1(_1998_),
    .Y(_2052_));
 sky130_fd_sc_hd__nand2_4 _3077_ (.A(net172),
    .B(net104),
    .Y(_2063_));
 sky130_fd_sc_hd__and2_4 _3078_ (.A(net206),
    .B(net196),
    .X(_2074_));
 sky130_fd_sc_hd__and3_1 _3079_ (.A(net215),
    ...
    .C(net196),
    .X(_2085_));
 sky130_fd_sc_hd__and2_4 _3080_ (.A(net208),
    .B(net202),
    .X(_2096_));
 sky130_fd_sc_hd__and3_1 _3081_ (.A(net217),
    ...
    .C(net167),
    .X(_2107_));
 sky130_fd_sc_hd__and3_4 _3082_ (.A(net215),
    .B(net167),
    .C(net197),
    .X(_2118_));
 ...
 sky130_fd_sc_hd__nand2_1 _3084_ (.A(_2118_),
    .B(_2129_),
    .Y(_2140_));
 sky130_fd_sc_hd__xnor2_2 _3085_ (.A(_2107_),
    .B(_2085_),
    .Y(_2151_));
 sky130_fd_sc_hd__xnor2_4 _3086_ (.A(_2063_),
    .B(net336),
    .Y(_2162_));
 ...
 sky130_fd_sc_hd__and2_1 _3088_ (.A(net235),
    .B(net171),
    .X(_2184_));
 sky130_fd_sc_hd__and3_1 _3089_ (.A(net283),
    .B(net199),
    .C(net169),
    .X(_2194_));
 ...
 sky130_fd_sc_hd__nand2_1 _3092_ (.A(net169),
    .B(net104),
    .Y(_2227_));
 sky130_fd_sc_hd__o21a_1 _3093_ (.A1(_2151_),
    .A2(_2063_),
    .B1(_2140_),
    .X(_2238_));
 sky130_fd_sc_hd__nand2_2 _3094_ (.A(net172),
    .B(net91),
    .Y(_2249_));
 sky130_fd_sc_hd__and3_4 _3095_ (.A(net215),
    .B(net199),
    .C(net167),
    .X(_2260_));
 sky130_fd_sc_hd__and2_4 _3096_ (.A(net206),
    .B(net195),
    .X(_2271_));
 sky130_fd_sc_hd__and3_4 _3097_ (.A(net216),
    .B(net174),
    .C(net195),
    .X(_2282_));
 sky130_fd_sc_hd__nand2_1 _3098_ (.A(_2260_),
    .B(_2282_),
    .Y(_2293_));
 sky130_fd_sc_hd__xnor2_4 _3099_ (.A(_2282_),
    .B(_2260_),
    .Y(_2304_));
 sky130_fd_sc_hd__xnor2_2 _3100_ (.A(_2304_),
    .B(_2249_),
    .Y(_2314_));
 sky130_fd_sc_hd__nor2_1 _3101_ (.A(_2314_),
    .B(net277),
    .Y(_2320_));
 sky130_fd_sc_hd__xor2_2 _3102_ (.A(_2314_),
    .B(_2238_),
    .X(_2326_));
 ...
 sky130_fd_sc_hd__xnor2_2 _3106_ (.A(_2216_),
    .B(_2332_),
    .Y(_2350_));
 sky130_fd_sc_hd__and2_4 _3107_ (.A(net215),
    .B(net165),
    .X(_2356_));
 sky130_fd_sc_hd__and2_2 _3108_ (.A(net236),
    .B(net163),
    .X(_2362_));
 sky130_fd_sc_hd__and2_4 _3109_ (.A(net208),
    .B(net205),
    .X(_2369_));
 ...
 sky130_fd_sc_hd__nand4_1 _3111_ (.A(net165),
    ...
    .D(net76),
    .Y(_2382_));
 sky130_fd_sc_hd__nand2_2 _3112_ (.A(net165),
    .B(net88),
    .Y(_2389_));
 sky130_fd_sc_hd__and3_4 _3113_ (.A(net218),
    .B(net204),
    .C(net161),
    .X(_2396_));
 ...
 sky130_fd_sc_hd__nand2_1 _3129_ (.A(_2260_),
    .B(_2420_),
    .Y(_2421_));
 sky130_fd_sc_hd__nand2_4 _3130_ (.A(net172),
    .B(net88),
    .Y(_2422_));
 sky130_fd_sc_hd__xnor2_1 _3131_ (.A(_2418_),
    .B(_2419_),
    .Y(_2423_));
 sky130_fd_sc_hd__or2_4 _3132_ (.A(_2423_),
    .B(_2422_),
    .X(_2424_));
 sky130_fd_sc_hd__xnor2_2 _3133_ (.A(_2030_),
    .B(_2041_),
    .Y(_2425_));
 sky130_fd_sc_hd__a21o_1 _3134_ (.A1(_2424_),
    .A2(_2421_),
    .B1(_2425_),
    .X(_2426_));
 sky130_fd_sc_hd__and3_1 _3135_ (.A(net283),
 ...
 sky130_fd_sc_hd__nand2_1 _3143_ (.A(_2382_),
    .B(_2434_),
    .Y(_2435_));
 sky130_fd_sc_hd__nor2_1 _3144_ (.A(_2435_),
    .B(_2433_),
    .Y(_2436_));
 sky130_fd_sc_hd__nand2_2 _3145_ (.A(_2435_),
    .B(_2433_),
    .Y(_2437_));
 ...
 sky130_fd_sc_hd__and4bb_1 _3157_ (.A_N(_2447_),
    ...
    .D(net76),
    .X(_2449_));
 sky130_fd_sc_hd__nand2_1 _3158_ (.A(net315),
    .B(_2449_),
    .Y(_2450_));
 sky130_fd_sc_hd__nor2_1 _3159_ (.A(_2417_),
    .B(_2450_),
    .Y(_2451_));
 sky130_fd_sc_hd__or3_4 _3160_ (.A(_2417_),
    .B(_2433_),
    .C(_2435_),
    .X(_2452_));
 ...
 sky130_fd_sc_hd__and2_1 _3165_ (.A(net207),
    .B(net194),
    .X(_2457_));
 sky130_fd_sc_hd__and3_4 _3166_ (.A(net216),
    .B(net174),
    .C(net194),
    .X(_2458_));
 sky130_fd_sc_hd__nand2_1 _3167_ (.A(_1987_),
    .B(_2458_),
    .Y(_2459_));
 sky130_fd_sc_hd__xnor2_2 _3168_ (.A(_2458_),
    .B(_1987_),
    .Y(_2460_));
 sky130_fd_sc_hd__xnor2_2 _3169_ (.A(_2460_),
    .B(_2456_),
    .Y(_2461_));
 ...
 sky130_fd_sc_hd__nand2_1 _3176_ (.A(net199),
    .B(_2356_),
    .Y(_2468_));
 sky130_fd_sc_hd__and3_4 _3177_ (.A(net218),
    .B(net202),
    .C(net161),
    .X(_2469_));
 sky130_fd_sc_hd__nor2_1 _3178_ (.A(_2408_),
    .B(_2469_),
    .Y(_2470_));
 sky130_fd_sc_hd__and3_4 _3179_ (.A(net218),
    .B(net202),
    .C(net158),
    .X(_2471_));
 sky130_fd_sc_hd__nand2_1 _3180_ (.A(_2396_),
    .B(_2471_),
    .Y(_2472_));
 sky130_fd_sc_hd__a2bb2o_4 _3181_ (.A1_N(_2469_),
    .A2_N(_2408_),
    .B1(_2471_),
    .B2(_2396_),
    .X(_2473_));
 sky130_fd_sc_hd__xnor2_2 _3182_ (.A(_2473_),
    .B(_2468_),
    .Y(_2474_));
 ...
 sky130_fd_sc_hd__nor2_1 _3188_ (.A(_2466_),
    .B(_2479_),
    .Y(_2480_));
 sky130_fd_sc_hd__xnor2_2 _3189_ (.A(_2479_),
    .B(_2466_),
    .Y(_2481_));
 sky130_fd_sc_hd__nor2_1 _3190_ (.A(_2415_),
    .B(_2481_),
    .Y(_2482_));
 sky130_fd_sc_hd__xor2_2 _3191_ (.A(_2481_),
    .B(_2415_),
    .X(_2483_));
 ...
 sky130_fd_sc_hd__nand2_1 _3193_ (.A(net154),
    .B(net76),
    .Y(_2485_));
 sky130_fd_sc_hd__and3_1 _3194_ (.A(_2483_),
    .B(net76),
    .C(net154),
    .X(_2486_));
 ...
 sky130_fd_sc_hd__xor2_1 _3206_ (.A(_2432_),
    .B(_2496_),
    .X(_2498_));
 sky130_fd_sc_hd__nand2_1 _3207_ (.A(net315),
    .B(_2447_),
    .Y(_2499_));
 ...
 sky130_fd_sc_hd__nand2_1 _3211_ (.A(net169),
    .B(net76),
    .Y(_2503_));
 sky130_fd_sc_hd__o22a_1 _3212_ (.A1(net281),
    .A2(_2500_),
    .B1(_2502_),
    .B2(_2503_),
    .X(_2504_));
 ...
 sky130_fd_sc_hd__nor2_1 _3216_ (.A(_2449_),
    .B(_2507_),
    .Y(_2508_));
 sky130_fd_sc_hd__and2_4 _3217_ (.A(_2506_),
    .B(_2508_),
    .X(_2509_));
 sky130_fd_sc_hd__or3_4 _3218_ (.A(_2438_),
    .B(_2447_),
    .C(_2449_),
    .X(_2510_));
 sky130_fd_sc_hd__and3_1 _3219_ (.A(_2510_),
    .B(_2499_),
    .C(_2450_),
    .X(_2511_));
 sky130_fd_sc_hd__a21boi_2 _3220_ (.A1(_2511_),
    .A2(_2509_),
    .B1_N(_2499_),
    .Y(_2512_));
 ...
 sky130_fd_sc_hd__xnor2_2 _3227_ (.A(\dsp.u_mac.acc_reg[6] ),
    .B(_2518_),
    .Y(_2519_));
 sky130_fd_sc_hd__xor2_4 _3228_ (.A(net383),
    .B(net276),
    .X(_2520_));
 sky130_fd_sc_hd__nand2_1 _3229_ (.A(\dsp.u_mac.acc_reg[5] ),
    .B(net320),
    .Y(_2521_));
 sky130_fd_sc_hd__xnor2_2 _3230_ (.A(_2520_),
    .B(\dsp.u_mac.acc_reg[5] ),
    .Y(_2522_));
 ...
 sky130_fd_sc_hd__a21o_1 _3252_ (.A1(_2525_),
    ...
    .B1(_2522_),
    .X(_2544_));
 sky130_fd_sc_hd__a21o_1 _3253_ (.A1(_2544_),
    .A2(_2521_),
    .B1(_2519_),
    .X(_2545_));
 sky130_fd_sc_hd__a21bo_4 _3254_ (.A1(\dsp.u_mac.acc_reg[6] ),
    .A2(net317),
    .B1_N(_2545_),
    .X(_2546_));
 sky130_fd_sc_hd__nand2b_4 _3255_ (.A_N(_2517_),
    .B(_2546_),
    .Y(_2547_));
 ...
 sky130_fd_sc_hd__nand2_1 _3260_ (.A(net173),
    .B(net72),
    .Y(_2552_));
 sky130_fd_sc_hd__and2_4 _3261_ (.A(\core.u_regfile.registers[1][8] ),
    .B(net207),
    .X(_2553_));
 sky130_fd_sc_hd__and3_4 _3262_ (.A(net216),
    .B(net174),
 ...
 sky130_fd_sc_hd__and2b_1 _3266_ (.A_N(_2557_),
    .B(_2551_),
    .X(_2558_));
 sky130_fd_sc_hd__xnor2_2 _3267_ (.A(_2557_),
    .B(_2551_),
    .Y(_2559_));
 sky130_fd_sc_hd__xnor2_4 _3268_ (.A(_2550_),
    .B(_2559_),
    .Y(_2560_));
 sky130_fd_sc_hd__and2b_1 _3269_ (.A_N(_2560_),
    .B(_2549_),
    .X(_2561_));
 sky130_fd_sc_hd__xnor2_4 _3270_ (.A(_2560_),
    .B(_2549_),
    .Y(_2562_));
 sky130_fd_sc_hd__o21ai_1 _3271_ (.A1(_2468_),
    ...
    .B1(_2472_),
    .Y(_2563_));
 sky130_fd_sc_hd__nand2_2 _3272_ (.A(net165),
    .B(net104),
    .Y(_2564_));
 ...
 sky130_fd_sc_hd__and3_1 _3274_ (.A(net219),
    ...
    .C(net158),
    .X(_2566_));
 sky130_fd_sc_hd__a2bb2o_4 _3275_ (.A1_N(_2471_),
    .A2_N(_2565_),
    .B1(_2566_),
    .B2(_2469_),
    .X(_2567_));
 ...
 sky130_fd_sc_hd__and2b_1 _3278_ (.A_N(_2569_),
    .B(_2563_),
    .X(_2570_));
 sky130_fd_sc_hd__xnor2_2 _3279_ (.A(_2569_),
    .B(_2563_),
    .Y(_2571_));
 sky130_fd_sc_hd__xnor2_2 _3280_ (.A(_2571_),
    .B(_2475_),
    .Y(_2572_));
 sky130_fd_sc_hd__nor2_1 _3281_ (.A(_2477_),
    .B(_2572_),
    .Y(_2573_));
 sky130_fd_sc_hd__xor2_2 _3282_ (.A(_2572_),
    .B(_2477_),
    .X(_2574_));
 ...
 sky130_fd_sc_hd__and2_1 _3284_ (.A(_2480_),
    .B(_2575_),
    .X(_2576_));
 sky130_fd_sc_hd__xnor2_2 _3285_ (.A(_2575_),
    .B(_2480_),
    .Y(_2577_));
 ...
 sky130_fd_sc_hd__and3_1 _3287_ (.A(net220),
    ...
    .C(net149),
    .X(_2579_));
 sky130_fd_sc_hd__and4_1 _3288_ (.A(net282),
    .B(net205),
    .C(net204),
    .D(net149),
    .X(_2580_));
 ...
 sky130_fd_sc_hd__nor2_1 _3291_ (.A(_2577_),
    .B(_2582_),
    .Y(_2583_));
 sky130_fd_sc_hd__xor2_2 _3292_ (.A(_2582_),
    .B(_2577_),
    .X(_2584_));
 sky130_fd_sc_hd__xor2_2 _3293_ (.A(_2584_),
    .B(_2486_),
    .X(_2585_));
 sky130_fd_sc_hd__xnor2_2 _3294_ (.A(_2585_),
    .B(_2482_),
    .Y(_2586_));
 sky130_fd_sc_hd__nand2_1 _3295_ (.A(_2586_),
    .B(_2489_),
    .Y(_2587_));
 ...
 sky130_fd_sc_hd__xor2_2 _3300_ (.A(_2548_),
    .B(_2590_),
    .X(_2592_));
 sky130_fd_sc_hd__xor2_2 _3301_ (.A(net267),
    .B(net340),
    .X(_2593_));
 ...
 sky130_fd_sc_hd__xnor2_2 _3303_ (.A(\dsp.u_mac.acc_reg[8] ),
    .B(_2593_),
    .Y(_2595_));
 sky130_fd_sc_hd__a21oi_4 _3304_ (.A1(_2547_),
    .A2(_2516_),
    .B1(_2595_),
    .Y(_2596_));
 ...
 sky130_fd_sc_hd__or4_1 _3309_ (.A(net175),
    ...
    .D(net165),
    .X(_2601_));
 sky130_fd_sc_hd__or4_4 _3310_ (.A(_2598_),
    .B(_2599_),
    .C(_2600_),
    .D(_2601_),
    .X(_2602_));
 sky130_fd_sc_hd__o41a_1 _3311_ (.A1(net136),
    ...
    .B1(net210),
    .X(_2603_));
 sky130_fd_sc_hd__o41a_1 _3312_ (.A1(net279),
    .A2(net160),
    .A3(net122),
    .A4(net116),
    .B1(net212),
 ...
 sky130_fd_sc_hd__or4_2 _3315_ (.A(_2603_),
    ...
    .D(_2606_),
    .X(_2607_));
 sky130_fd_sc_hd__a21oi_4 _3316_ (.A1(_2602_),
    .A2(net210),
    .B1(_2607_),
    .Y(_2608_));
 sky130_fd_sc_hd__a21o_4 _3317_ (.A1(net210),
    .A2(_2602_),
    .B1(_2607_),
    .X(_2609_));
 sky130_fd_sc_hd__a311oi_4 _3318_ (.A1(_2516_),
    .A2(net314),
    .A3(_2547_),
    .B1(_2596_),
    .C1(net36),
    .Y(\core.dsp_result_in[8] ));
 sky130_fd_sc_hd__a21o_1 _3319_ (.A1(_2587_),
    .A2(_2465_),
    .B1(_2588_),
    .X(_2610_));
 ...
 sky130_fd_sc_hd__a21oi_2 _3321_ (.A1(_2562_),
    ...
    .B1(_2573_),
    .Y(_2612_));
 sky130_fd_sc_hd__a21o_1 _3322_ (.A1(_2559_),
    .A2(_2550_),
    .B1(_2558_),
    .X(_2613_));
 ...
 sky130_fd_sc_hd__nand2_1 _3325_ (.A(net173),
    .B(net67),
    .Y(_2616_));
 sky130_fd_sc_hd__and2_4 _3326_ (.A(net212),
 ...
 sky130_fd_sc_hd__and2_1 _3330_ (.A(_2282_),
    .B(_2620_),
    .X(_2621_));
 sky130_fd_sc_hd__o2bb2a_4 _3331_ (.A1_N(_2282_),
    .A2_N(_2620_),
    .B1(_2619_),
    .B2(_2618_),
    .X(_2622_));
 sky130_fd_sc_hd__xor2_2 _3332_ (.A(_2622_),
    .B(_2616_),
    .X(_2623_));
 sky130_fd_sc_hd__and2b_1 _3333_ (.A_N(_2623_),
    .B(_2615_),
    .X(_2624_));
 sky130_fd_sc_hd__xnor2_2 _3334_ (.A(_2623_),
    .B(_2615_),
    .Y(_2625_));
 sky130_fd_sc_hd__xnor2_2 _3335_ (.A(_2625_),
    .B(_2614_),
    .Y(_2626_));
 sky130_fd_sc_hd__and2b_1 _3336_ (.A_N(_2626_),
    .B(_2613_),
    .X(_2627_));
 sky130_fd_sc_hd__xor2_2 _3337_ (.A(_2626_),
    .B(_2613_),
    .X(_2628_));
 sky130_fd_sc_hd__a21o_1 _3338_ (.A1(_2469_),
    ...
    .B1(_2568_),
    .X(_2629_));
 sky130_fd_sc_hd__and3_1 _3339_ (.A(net282),
    .B(net166),
    .C(net197),
    .X(_2630_));
 ...
 sky130_fd_sc_hd__and3_1 _3360_ (.A(_2644_),
    ...
    .C(_2649_),
    .X(_2651_));
 sky130_fd_sc_hd__xor2_2 _3361_ (.A(_2650_),
    .B(_2644_),
    .X(_2652_));
 ...
 sky130_fd_sc_hd__and2b_1 _3364_ (.A_N(_2654_),
    .B(_2611_),
    .X(_2655_));
 sky130_fd_sc_hd__xnor2_2 _3365_ (.A(_2654_),
    .B(_2611_),
    .Y(_2656_));
 sky130_fd_sc_hd__xor2_2 _3366_ (.A(_2656_),
    .B(_2561_),
    .X(_2657_));
 ...
 sky130_fd_sc_hd__xor2_2 _3374_ (.A(\dsp.u_mac.acc_reg[9] ),
    .B(_2663_),
    .X(_2665_));
 sky130_fd_sc_hd__o21ai_2 _3375_ (.A1(_2596_),
    .A2(_2594_),
    .B1(_2665_),
    .Y(_2666_));
 sky130_fd_sc_hd__o311a_4 _3376_ (.A1(_2594_),
    .A2(net313),
    .A3(_2665_),
    .B1(_2666_),
    .C1(net34),
 ...
 sky130_fd_sc_hd__nand2_1 _3393_ (.A(_2674_),
    .B(_2682_),
    .Y(_2683_));
 sky130_fd_sc_hd__xor2_1 _3394_ (.A(_2682_),
    .B(_2674_),
    .X(_2684_));
 ...
 sky130_fd_sc_hd__and3_1 _3404_ (.A(net219),
    ...
    .C(net161),
    .X(_2694_));
 sky130_fd_sc_hd__and3_1 _3405_ (.A(net282),
    .B(net198),
    .C(net158),
    .X(_2695_));
 ...
 sky130_fd_sc_hd__or2_1 _3429_ (.A(_2710_),
    .B(_2718_),
    .X(_2719_));
 sky130_fd_sc_hd__xor2_1 _3430_ (.A(_2718_),
    .B(_2710_),
    .X(_2720_));
 ...
 sky130_fd_sc_hd__xor2_1 _3439_ (.A(_2667_),
    .B(_2728_),
    .X(_2729_));
 sky130_fd_sc_hd__or2_4 _3440_ (.A(\dsp.u_mac.acc_reg[10] ),
    .B(_2729_),
    .X(_2730_));
 ...
 sky130_fd_sc_hd__nand3_1 _3443_ (.A(_2664_),
    ...
    .C(_2732_),
    .Y(_2733_));
 sky130_fd_sc_hd__a21o_1 _3444_ (.A1(_2666_),
    .A2(_2664_),
    .B1(_2732_),
    .X(_2734_));
 ...
 sky130_fd_sc_hd__xnor2_2 _3466_ (.A(_2740_),
    .B(_2753_),
    .Y(_2755_));
 sky130_fd_sc_hd__xor2_2 _3467_ (.A(_2755_),
    .B(_2739_),
    .X(_2756_));
 ...
 sky130_fd_sc_hd__nand2b_1 _3481_ (.A_N(_2757_),
    .B(_2769_),
    .Y(_2770_));
 sky130_fd_sc_hd__xnor2_2 _3482_ (.A(_2769_),
    .B(_2757_),
    .Y(_2771_));
 sky130_fd_sc_hd__xnor2_2 _3483_ (.A(_2703_),
    .B(_2771_),
    .Y(_2772_));
 sky130_fd_sc_hd__xor2_2 _3484_ (.A(net378),
    .B(_2772_),
    .X(_2773_));
 sky130_fd_sc_hd__nand2_1 _3485_ (.A(_2738_),
    .B(_2773_),
    .Y(_2774_));
 sky130_fd_sc_hd__xor2_1 _3486_ (.A(_2773_),
    .B(_2738_),
    .X(_2775_));
 ...
 sky130_fd_sc_hd__xnor2_1 _3503_ (.A(_2736_),
    .B(_2790_),
    .Y(_2792_));
 sky130_fd_sc_hd__or2_4 _3504_ (.A(_2735_),
    .B(_2792_),
    .X(_2793_));
 ...
 sky130_fd_sc_hd__nor2_2 _3579_ (.A(_2865_),
    .B(_2866_),
    .Y(_2867_));
 sky130_fd_sc_hd__a221o_2 _3580_ (.A1(_2728_),
    .A2(_2667_),
    .B1(_2735_),
    .B2(_2792_),
    .C1(_2727_),
 ...
 sky130_fd_sc_hd__nor2_1 _3584_ (.A(\dsp.u_mac.acc_reg[12] ),
    .B(_2871_),
    .Y(_2872_));
 sky130_fd_sc_hd__and2_4 _3585_ (.A(_2871_),
    .B(\dsp.u_mac.acc_reg[12] ),
    .X(_2873_));
 sky130_fd_sc_hd__or2_4 _3586_ (.A(_2872_),
    .B(_2873_),
    .X(_2874_));
 sky130_fd_sc_hd__a21oi_4 _3587_ (.A1(_2799_),
    .A2(_2802_),
    .B1(_2874_),
    .Y(_2875_));
 ...
 sky130_fd_sc_hd__and2_1 _3661_ (.A(_2946_),
    .B(_2947_),
    .X(_2948_));
 sky130_fd_sc_hd__o21ai_4 _3662_ (.A1(_2875_),
    .A2(net295),
    .B1(_2948_),
    .Y(_2949_));
 sky130_fd_sc_hd__o311a_1 _3663_ (.A1(net295),
    .A2(_2875_),
    .A3(_2948_),
    .B1(_2949_),
    .C1(net34),
 ...
 sky130_fd_sc_hd__and3_1 _3711_ (.A(net222),
    ...
    .C(net135),
    .X(_2997_));
 sky130_fd_sc_hd__nand3_2 _3712_ (.A(net138),
    .B(net88),
    .C(_2997_),
    .Y(_2998_));
 sky130_fd_sc_hd__and2_4 _3713_ (.A(_2921_),
    .B(_2998_),
    .X(_2999_));
 ...
 sky130_fd_sc_hd__nor2_1 _3716_ (.A(_2921_),
    .B(_2998_),
    .Y(_3002_));
 sky130_fd_sc_hd__or3_4 _3717_ (.A(_2999_),
    .B(_3001_),
    .C(_3002_),
    .X(_3003_));
 ...
 sky130_fd_sc_hd__nand2_1 _3721_ (.A(_3004_),
    .B(_3006_),
    .Y(_3007_));
 sky130_fd_sc_hd__or2_4 _3722_ (.A(_3003_),
    .B(_3007_),
    .X(_3008_));
 ...
 sky130_fd_sc_hd__o21ba_1 _3742_ (.A1(_2865_),
    ...
    .B1_N(_2942_),
    .X(_3028_));
 sky130_fd_sc_hd__a41oi_4 _3743_ (.A1(_2868_),
    .A2(_2867_),
    .A3(_2793_),
    .A4(_2943_),
    .B1(_3028_),
 ...
 sky130_fd_sc_hd__nor2_1 _3746_ (.A(\dsp.u_mac.acc_reg[14] ),
    .B(_3031_),
    .Y(_3032_));
 sky130_fd_sc_hd__and2_4 _3747_ (.A(\dsp.u_mac.acc_reg[14] ),
    .B(_3031_),
    .X(_3033_));
 sky130_fd_sc_hd__or2_4 _3748_ (.A(_3032_),
    .B(_3033_),
    .X(_3034_));
 sky130_fd_sc_hd__a21oi_4 _3749_ (.A1(_2949_),
    .A2(_2947_),
    .B1(_3034_),
    .Y(_3035_));
 ...
 sky130_fd_sc_hd__a21oi_2 _3806_ (.A1(\core.u_regfile.registers[2][15] ),
    ...
    .B1(_3005_),
    .Y(_0093_));
 sky130_fd_sc_hd__and3_1 _3807_ (.A(net74),
 ...
 sky130_fd_sc_hd__or2_1 _3814_ (.A(_3011_),
    .B(_0100_),
    .X(_0101_));
 sky130_fd_sc_hd__xnor2_2 _3815_ (.A(_0100_),
    .B(_3011_),
    .Y(_0102_));
 sky130_fd_sc_hd__xor2_2 _3816_ (.A(_0102_),
    .B(_0085_),
    .X(_0103_));
 ...
 sky130_fd_sc_hd__and2_1 _3833_ (.A(_0118_),
    .B(_0119_),
    .X(_0120_));
 sky130_fd_sc_hd__o21ai_4 _3834_ (.A1(_3035_),
    .A2(_3033_),
    .B1(_0120_),
    .Y(_0121_));
 sky130_fd_sc_hd__o311a_4 _3835_ (.A1(_3033_),
    .A2(_3035_),
    .A3(_0120_),
    .B1(net34),
    .C1(_0121_),
 ...
 sky130_fd_sc_hd__a21o_1 _3837_ (.A1(_3026_),
    ...
    .B1(_0113_),
    .X(_0123_));
 sky130_fd_sc_hd__o21ai_4 _3838_ (.A1(_0122_),
    .A2(_3029_),
    .B1(_0123_),
    .Y(_0124_));
 ...
 sky130_fd_sc_hd__nand2b_1 _3855_ (.A_N(_0131_),
    .B(_0140_),
    .Y(_0141_));
 sky130_fd_sc_hd__xor2_1 _3856_ (.A(_0140_),
    .B(_0131_),
    .X(_0142_));
 ...
 sky130_fd_sc_hd__xnor2_1 _3858_ (.A(_0130_),
    .B(_0142_),
    .Y(_0144_));
 sky130_fd_sc_hd__xor2_2 _3859_ (.A(_0144_),
    .B(_0129_),
    .X(_0145_));
 ...
 sky130_fd_sc_hd__nor2_2 _3865_ (.A(_0149_),
    .B(_0150_),
    .Y(_0151_));
 sky130_fd_sc_hd__xor2_1 _3866_ (.A(_0151_),
    .B(_0148_),
    .X(_0152_));
 ...
 sky130_fd_sc_hd__nand2_1 _3891_ (.A(_0175_),
    .B(_0176_),
    .Y(_0177_));
 sky130_fd_sc_hd__o21bai_4 _3892_ (.A1(_0092_),
    .A2(_0093_),
    .B1_N(_0094_),
    .Y(_0178_));
 sky130_fd_sc_hd__nand2b_1 _3893_ (.A_N(_0177_),
    .B(_0178_),
    .Y(_0179_));
 sky130_fd_sc_hd__xor2_2 _3894_ (.A(_0178_),
    .B(_0177_),
    .X(_0180_));
 sky130_fd_sc_hd__xor2_2 _3895_ (.A(_0180_),
    .B(_0087_),
    .X(_0181_));
 ...
 sky130_fd_sc_hd__nand2_1 _3903_ (.A(\core.u_regfile.registers[2][16] ),
    .B(net74),
    .Y(_0189_));
 sky130_fd_sc_hd__nor2_4 _3904_ (.A(_0188_),
    .B(_0189_),
    .Y(_0190_));
 ...
 sky130_fd_sc_hd__and2b_1 _3906_ (.A_N(_0190_),
    .B(_0191_),
    .X(_0192_));
 sky130_fd_sc_hd__nand2_4 _3907_ (.A(_0192_),
    .B(_0181_),
    .Y(_0193_));
 sky130_fd_sc_hd__xnor2_2 _3908_ (.A(_0192_),
    .B(_0181_),
    .Y(_0194_));
 ...
 sky130_fd_sc_hd__nor2_1 _3910_ (.A(_0097_),
    .B(_0194_),
    .Y(_0196_));
 sky130_fd_sc_hd__xnor2_2 _3911_ (.A(_0194_),
    .B(_0097_),
    .Y(_0197_));
 sky130_fd_sc_hd__xnor2_2 _3912_ (.A(_0197_),
    .B(_0174_),
    .Y(_0198_));
 sky130_fd_sc_hd__and2b_1 _3913_ (.A_N(_0173_),
    .B(_0198_),
    .X(_0199_));
 sky130_fd_sc_hd__xnor2_2 _3914_ (.A(_0198_),
    .B(_0173_),
    .Y(_0200_));
 ...
 sky130_fd_sc_hd__and2b_1 _3916_ (.A_N(_0167_),
    .B(_0201_),
    .X(_0202_));
 sky130_fd_sc_hd__xnor2_2 _3917_ (.A(_0201_),
    .B(_0167_),
    .Y(_0203_));
 sky130_fd_sc_hd__xor2_1 _3918_ (.A(_0203_),
    .B(_0166_),
    .X(_0204_));
 sky130_fd_sc_hd__xor2_1 _3919_ (.A(_0204_),
    .B(_0128_),
    .X(_0205_));
 sky130_fd_sc_hd__xnor2_4 _3920_ (.A(_0079_),
    .B(net261),
    .Y(_0206_));
 sky130_fd_sc_hd__nand2_1 _3921_ (.A(_0127_),
    .B(_0206_),
    .Y(_0207_));
 sky130_fd_sc_hd__xnor2_2 _3922_ (.A(_0206_),
    .B(_0127_),
    .Y(_0208_));
 sky130_fd_sc_hd__nand2b_4 _3923_ (.A_N(_0208_),
    .B(_0126_),
    .Y(_0209_));
 sky130_fd_sc_hd__xnor2_2 _3924_ (.A(_0208_),
    .B(_0126_),
    .Y(_0210_));
 sky130_fd_sc_hd__and2_4 _3925_ (.A(_0210_),
    .B(_0125_),
    .X(_0211_));
 ...
 sky130_fd_sc_hd__nand2_1 _3931_ (.A(_0215_),
    .B(_0216_),
    .Y(_0217_));
 sky130_fd_sc_hd__a21oi_4 _3932_ (.A1(_0121_),
    .A2(_0119_),
    .B1(_0217_),
    .Y(_0218_));
 ...
 sky130_fd_sc_hd__a31o_1 _3934_ (.A1(net139),
    ...
    .B1(_0143_),
    .X(_0219_));
 sky130_fd_sc_hd__a32o_2 _3935_ (.A1(_0205_),
    .A2(_0078_),
    .A3(_3040_),
    .B1(net259),
    .B2(_0128_),
 ...
 sky130_fd_sc_hd__a21o_1 _3936_ (.A1(_0166_),
    ...
    .B1(_0202_),
    .X(_0221_));
 sky130_fd_sc_hd__o21ai_2 _3937_ (.A1(net280),
    .A2(_0160_),
    .B1(_0161_),
    .Y(_0222_));
 ...
 sky130_fd_sc_hd__nand4_1 _3942_ (.A(\core.u_regfile.registers[1][14] ),
    ...
    .D(net48),
    .Y(_0227_));
 sky130_fd_sc_hd__a22o_1 _3943_ (.A1(net279),
    .A2(net52),
    .B1(_0226_),
    .B2(net178),
    .X(_0228_));
 ...
 sky130_fd_sc_hd__nor2_1 _3960_ (.A(_0243_),
    .B(_0244_),
    .Y(_0245_));
 sky130_fd_sc_hd__xor2_1 _3961_ (.A(_0245_),
    .B(_0242_),
    .X(_0246_));
 ...
 sky130_fd_sc_hd__or3_1 _3968_ (.A(_0154_),
    ...
    .C(_0251_),
    .X(_0253_));
 sky130_fd_sc_hd__and2_4 _3969_ (.A(_0252_),
    .B(_0253_),
    .X(_0254_));
 sky130_fd_sc_hd__and2b_1 _3970_ (.A_N(_0158_),
    .B(_0254_),
    .X(_0255_));
 sky130_fd_sc_hd__xor2_2 _3971_ (.A(_0254_),
    .B(_0158_),
    .X(_0256_));
 sky130_fd_sc_hd__nor2_1 _3972_ (.A(_0240_),
    .B(_0256_),
    .Y(_0257_));
 sky130_fd_sc_hd__xor2_2 _3973_ (.A(_0256_),
    .B(_0240_),
    .X(_0258_));
 sky130_fd_sc_hd__nand2_1 _3974_ (.A(_0222_),
    .B(_0258_),
    .Y(_0259_));
 sky130_fd_sc_hd__xnor2_2 _3975_ (.A(_0258_),
    .B(_0222_),
    .Y(_0260_));
 ...
 sky130_fd_sc_hd__nor2_1 _4000_ (.A(_0281_),
    .B(_0284_),
    .Y(_0285_));
 sky130_fd_sc_hd__xor2_4 _4001_ (.A(_0281_),
    .B(_0284_),
    .X(_0286_));
 sky130_fd_sc_hd__nand2_1 _4002_ (.A(_0190_),
    .B(_0286_),
    .Y(_0287_));
 sky130_fd_sc_hd__xor2_4 _4003_ (.A(_0190_),
    .B(_0286_),
    .X(_0288_));
 sky130_fd_sc_hd__xnor2_4 _4004_ (.A(_0275_),
    .B(_0288_),
    .Y(_0289_));
 sky130_fd_sc_hd__xor2_4 _4005_ (.A(_0289_),
    .B(_0193_),
    .X(_0290_));
 sky130_fd_sc_hd__and2b_1 _4006_ (.A_N(_0268_),
    .B(_0290_),
    .X(_0291_));
 sky130_fd_sc_hd__xnor2_4 _4007_ (.A(_0290_),
    .B(_0268_),
    .Y(_0292_));
 sky130_fd_sc_hd__xor2_4 _4008_ (.A(_0267_),
    .B(_0292_),
    .X(_0293_));
 sky130_fd_sc_hd__xnor2_4 _4009_ (.A(_0266_),
    .B(_0293_),
    .Y(_0294_));
 ...
 sky130_fd_sc_hd__xnor2_2 _4011_ (.A(_0261_),
    .B(_0294_),
    .Y(_0296_));
 sky130_fd_sc_hd__xor2_2 _4012_ (.A(_0296_),
    .B(_0260_),
    .X(_0297_));
 sky130_fd_sc_hd__nand2_1 _4013_ (.A(_0221_),
    .B(net258),
    .Y(_0298_));
 sky130_fd_sc_hd__xnor2_2 _4014_ (.A(_0297_),
    .B(_0221_),
    .Y(_0299_));
 sky130_fd_sc_hd__xor2_2 _4015_ (.A(_0164_),
    .B(_0299_),
    .X(_0300_));
 sky130_fd_sc_hd__xnor2_2 _4016_ (.A(_0300_),
    .B(_0220_),
    .Y(_0301_));
 sky130_fd_sc_hd__and2b_1 _4017_ (.A_N(_0301_),
    .B(_0219_),
    .X(_0302_));
 sky130_fd_sc_hd__xor2_1 _4018_ (.A(_0301_),
    .B(_0219_),
    .X(_0303_));
 sky130_fd_sc_hd__nand3_2 _4019_ (.A(_0303_),
    .B(_0209_),
    .C(_0207_),
    .Y(_0304_));
 sky130_fd_sc_hd__inv_2 _4020_ (.A(net264),
    .Y(_0305_));
 ...
 sky130_fd_sc_hd__xor2_2 _4080_ (.A(_0360_),
    .B(_0363_),
    .X(_0364_));
 sky130_fd_sc_hd__o21ba_4 _4081_ (.A1(_0193_),
    .A2(_0289_),
    .B1_N(_0291_),
    .X(_0365_));
 ...
 sky130_fd_sc_hd__and3_1 _4098_ (.A(net209),
    ...
    .C(net122),
    .X(_0382_));
 sky130_fd_sc_hd__and3_1 _4099_ (.A(net359),
    .B(net205),
    .C(net120),
    .X(_0383_));
 sky130_fd_sc_hd__and3_1 _4100_ (.A(net359),
    .B(net203),
    .C(net120),
    .X(_0384_));
 ...
 sky130_fd_sc_hd__and2b_1 _4115_ (.A_N(_0365_),
    .B(_0398_),
    .X(_0399_));
 sky130_fd_sc_hd__xnor2_4 _4116_ (.A(_0398_),
    .B(_0365_),
    .Y(_0400_));
 sky130_fd_sc_hd__xor2_2 _4117_ (.A(_0400_),
    .B(_0364_),
    .X(_0401_));
 sky130_fd_sc_hd__nand2b_1 _4118_ (.A_N(_0359_),
    .B(net268),
    .Y(_0402_));
 sky130_fd_sc_hd__xnor2_2 _4119_ (.A(_0401_),
    .B(_0359_),
    .Y(_0403_));
 sky130_fd_sc_hd__xor2_2 _4120_ (.A(_0403_),
    .B(_0358_),
    .X(_0404_));
 ...
 sky130_fd_sc_hd__nand2_1 _4123_ (.A(_0318_),
    .B(_0406_),
    .Y(_0407_));
 sky130_fd_sc_hd__xnor2_1 _4124_ (.A(_0406_),
    .B(_0318_),
    .Y(_0408_));
 sky130_fd_sc_hd__nand2b_1 _4125_ (.A_N(_0408_),
    .B(_0317_),
    .Y(_0409_));
 sky130_fd_sc_hd__xor2_1 _4126_ (.A(_0408_),
    .B(_0317_),
    .X(_0410_));
 ...
 sky130_fd_sc_hd__nand2_1 _4129_ (.A(_0411_),
    .B(_0412_),
    .Y(_0413_));
 sky130_fd_sc_hd__and2_4 _4130_ (.A(_0211_),
    .B(_0304_),
    .X(_0414_));
 sky130_fd_sc_hd__a311o_4 _4131_ (.A1(_0124_),
    .A2(_0304_),
    .A3(_0213_),
    .B1(_0306_),
    .C1(_0414_),
 ...
 sky130_fd_sc_hd__o21ai_2 _4210_ (.A1(_0381_),
    ...
    .B1(_0385_),
    .Y(_0493_));
 sky130_fd_sc_hd__and3_1 _4211_ (.A(net359),
    .B(net201),
    .C(net124),
    .X(_0494_));
 ...
 sky130_fd_sc_hd__nor2_1 _4232_ (.A(_0425_),
    .B(_0514_),
    .Y(_0515_));
 sky130_fd_sc_hd__xor2_1 _4233_ (.A(_0514_),
    .B(_0425_),
    .X(_0516_));
 sky130_fd_sc_hd__xor2_1 _4234_ (.A(_0516_),
    .B(_0356_),
    .X(_0517_));
 ...
 sky130_fd_sc_hd__nand2_1 _4243_ (.A(\dsp.u_mac.acc_reg[19] ),
    .B(_0525_),
    .Y(_0526_));
 sky130_fd_sc_hd__or2_4 _4244_ (.A(\dsp.u_mac.acc_reg[19] ),
    .B(_0525_),
    .X(_0527_));
 sky130_fd_sc_hd__and2_4 _4245_ (.A(_0526_),
    .B(_0527_),
    .X(_0528_));
 ...
 sky130_fd_sc_hd__o21a_1 _4247_ (.A1(_0528_),
    ...
    .B1(net34),
    .X(_0530_));
 sky130_fd_sc_hd__a21boi_4 _4248_ (.A1(net300),
    .A2(net289),
    .B1_N(_0530_),
    .Y(\core.dsp_result_in[19] ));
 sky130_fd_sc_hd__a21oi_2 _4249_ (.A1(_0522_),
    .A2(_0411_),
    .B1(_0521_),
    .Y(_0531_));
 ...
 sky130_fd_sc_hd__a21o_1 _4309_ (.A1(_0484_),
    ...
    .B1(_0504_),
    .X(_0591_));
 sky130_fd_sc_hd__and3_1 _4310_ (.A(net321),
    .B(\core.u_regfile.registers[1][9] ),
    .C(net136),
    .X(_0592_));
 ...
 sky130_fd_sc_hd__and3_1 _4320_ (.A(net214),
    ...
    .C(net129),
    .X(_0602_));
 sky130_fd_sc_hd__and3_1 _4321_ (.A(net321),
    .B(net196),
    .C(net125),
    .X(_0603_));
 ...
 sky130_fd_sc_hd__a21oi_1 _4326_ (.A1(_0494_),
    ...
    .B1(_0498_),
    .Y(_0608_));
 sky130_fd_sc_hd__and3_1 _4327_ (.A(net359),
    .B(net198),
    .C(net124),
    .X(_0609_));
 sky130_fd_sc_hd__and3_1 _4328_ (.A(net359),
    .B(net201),
    .C(net122),
    .X(_0610_));
 ...
 sky130_fd_sc_hd__a41oi_4 _4363_ (.A1(_0218_),
    ...
    .B1(_0644_),
    .Y(_0645_));
 sky130_fd_sc_hd__or2_4 _4364_ (.A(_0642_),
    .B(_0645_),
    .X(_0646_));
 ...
 sky130_fd_sc_hd__a21oi_2 _4431_ (.A1(_0599_),
    ...
    .B1(_0619_),
    .Y(_0712_));
 sky130_fd_sc_hd__and3_1 _4432_ (.A(net321),
    .B(\core.u_regfile.registers[1][10] ),
    .C(net134),
    .X(_0713_));
 ...
 sky130_fd_sc_hd__xor2_1 _4485_ (.A(_0764_),
    .B(_0765_),
    .X(_0766_));
 sky130_fd_sc_hd__nor2_2 _4486_ (.A(_0766_),
    .B(net37),
 ...
 sky130_fd_sc_hd__nor2_1 _4608_ (.A(_0885_),
    .B(_0887_),
    .Y(_0888_));
 sky130_fd_sc_hd__o2111a_4 _4609_ (.A1(_0531_),
    .A2(_0415_),
    .B1(_0532_),
    .C1(_0638_),
    .D1(_0758_),
 ...
 sky130_fd_sc_hd__a31o_1 _4610_ (.A1(_0534_),
    ...
    .B1(_0757_),
    .X(_0890_));
 sky130_fd_sc_hd__nor2_8 _4611_ (.A(_0890_),
    .B(_0889_),
    .Y(_0891_));
 sky130_fd_sc_hd__xnor2_2 _4612_ (.A(_0888_),
    .B(_0891_),
    .Y(_0892_));
 sky130_fd_sc_hd__and2_4 _4613_ (.A(\dsp.u_mac.acc_reg[22] ),
    .B(_0892_),
    .X(_0893_));
 sky130_fd_sc_hd__nor2_1 _4614_ (.A(\dsp.u_mac.acc_reg[22] ),
    .B(_0892_),
    .Y(_0894_));
 sky130_fd_sc_hd__or2_4 _4615_ (.A(_0893_),
    .B(_0894_),
    .X(_0895_));
 ...
 sky130_fd_sc_hd__nand2_1 _4744_ (.A(_1021_),
    .B(_1022_),
    .Y(_1023_));
 sky130_fd_sc_hd__o21a_1 _4745_ (.A1(_0891_),
    .A2(_0887_),
    .B1(_0886_),
    .X(_1024_));
 sky130_fd_sc_hd__xor2_2 _4746_ (.A(_1024_),
    .B(_1023_),
    .X(_1025_));
 sky130_fd_sc_hd__xor2_2 _4747_ (.A(_1025_),
    .B(\dsp.u_mac.acc_reg[23] ),
    .X(_1026_));
 ...
 sky130_fd_sc_hd__o21ai_1 _4751_ (.A1(\dsp.u_mac.acc_reg[23] ),
    ...
    .B1(_1028_),
    .Y(_1029_));
 sky130_fd_sc_hd__nand2b_4 _4752_ (.A_N(_0895_),
    .B(_1026_),
    .Y(_1030_));
 sky130_fd_sc_hd__a211o_1 _4753_ (.A1(_0640_),
    ...
    .C1(_1030_),
    .X(_1031_));
 sky130_fd_sc_hd__o41a_4 _4754_ (.A1(_0642_),
    .A2(_0645_),
    .A3(_1030_),
    .A4(_0764_),
    .B1(_1029_),
 ...
 sky130_fd_sc_hd__xor2_1 _4893_ (.A(_1035_),
    .B(_1169_),
    .X(_1171_));
 sky130_fd_sc_hd__a21oi_4 _4894_ (.A1(_1033_),
    .A2(_1034_),
    .B1(_1171_),
    .Y(_1172_));
 ...
 sky130_fd_sc_hd__or2_1 _4899_ (.A(_1175_),
    .B(_1176_),
    .X(_1177_));
 sky130_fd_sc_hd__a21oi_4 _4900_ (.A1(_1031_),
    .A2(_1032_),
    .B1(_1177_),
    .Y(_1178_));
 ...
 sky130_fd_sc_hd__and3_1 _4911_ (.A(net233),
    ...
    .C(net177),
    .X(_1188_));
 sky130_fd_sc_hd__a21oi_1 _4912_ (.A1(net279),
    .A2(_0774_),
    .B1(_1188_),
    .Y(_1189_));
 ...
 sky130_fd_sc_hd__o21ai_2 _5046_ (.A1(_1175_),
    ...
    .B1(_1321_),
    .Y(_1323_));
 sky130_fd_sc_hd__o311a_4 _5047_ (.A1(_1175_),
    .A2(_1321_),
    .A3(_1178_),
    .B1(_1323_),
    .C1(net35),
 ...
 sky130_fd_sc_hd__a21o_1 _5203_ (.A1(\dsp.u_mac.acc_reg[25] ),
    ...
    .B1(_1175_),
    .X(_1479_));
 sky130_fd_sc_hd__a211o_1 _5204_ (.A1(_1032_),
    .A2(_1031_),
    .B1(_1177_),
    .C1(_1322_),
    .X(_1480_));
 ...
 sky130_fd_sc_hd__nor3b_2 _5206_ (.A(_1478_),
    ...
    .C_N(_1480_),
    .Y(_1482_));
 sky130_fd_sc_hd__o211a_4 _5207_ (.A1(_1479_),
    .A2(_1178_),
    .B1(_1478_),
    .C1(_1320_),
    .X(_1483_));
 sky130_fd_sc_hd__nor3_4 _5208_ (.A(net37),
    .B(_1483_),
    .C(_1482_),
 ...
 sky130_fd_sc_hd__o21ai_1 _5340_ (.A1(_1444_),
    ...
    .B1(_1613_),
    .Y(_1615_));
 sky130_fd_sc_hd__and2_4 _5341_ (.A(_1614_),
    .B(_1615_),
    .X(_1616_));
 ...
 sky130_fd_sc_hd__xnor2_1 _5344_ (.A(_1594_),
    .B(_1616_),
    .Y(_1619_));
 sky130_fd_sc_hd__xnor2_1 _5345_ (.A(_1619_),
    .B(_1584_),
    .Y(_1620_));
 sky130_fd_sc_hd__xnor2_1 _5346_ (.A(_1620_),
    .B(_1583_),
    .Y(_1621_));
 sky130_fd_sc_hd__nor3b_2 _5347_ (.A(_1452_),
    ...
    .C_N(_1621_),
    .Y(_1622_));
 sky130_fd_sc_hd__o21ba_4 _5348_ (.A1(_1452_),
    .A2(_1454_),
    .B1_N(_1621_),
    .X(_1623_));
 ...
 sky130_fd_sc_hd__o21ai_2 _5372_ (.A1(_1476_),
    ...
    .B1(_1646_),
    .Y(_1647_));
 sky130_fd_sc_hd__o311a_4 _5373_ (.A1(_1476_),
    .A2(_1483_),
    .A3(_1646_),
    .B1(_1647_),
    .C1(net35),
 ...
 sky130_fd_sc_hd__a21oi_1 _5532_ (.A1(_1628_),
    ...
    .B1(_1805_),
    .Y(_1806_));
 sky130_fd_sc_hd__xor2_2 _5533_ (.A(_1805_),
    .B(_1652_),
    .X(_1807_));
 ...
 sky130_fd_sc_hd__nand2_1 _5553_ (.A(_1821_),
    .B(_1826_),
    .Y(_1827_));
 sky130_fd_sc_hd__or2_4 _5554_ (.A(_1821_),
    .B(_1826_),
    .X(_1828_));
 sky130_fd_sc_hd__and3_4 _5555_ (.A(net35),
    .B(_1828_),
    .C(_1827_),
 ...
 sky130_fd_sc_hd__a211oi_2 _5689_ (.A1(_1786_),
    ...
    .C1(_1966_),
    .Y(_1968_));
 sky130_fd_sc_hd__or3_4 _5690_ (.A(_1930_),
    .B(_1967_),
    .C(_1968_),
    .X(_1969_));
 ...
 sky130_fd_sc_hd__a211oi_2 _5693_ (.A1(_1969_),
    ...
    .C1(_1794_),
    .Y(_1972_));
 sky130_fd_sc_hd__o211a_4 _5694_ (.A1(_1792_),
    .A2(_1794_),
    .B1(_1969_),
    .C1(_1971_),
    .X(_1973_));
 ...
 sky130_fd_sc_hd__xor2_1 _5704_ (.A(_1829_),
    .B(_1983_),
    .X(_1984_));
 sky130_fd_sc_hd__or3_4 _5705_ (.A(_1808_),
    .B(_1806_),
    .C(_1984_),
    .X(_1985_));
 sky130_fd_sc_hd__o21ai_2 _5706_ (.A1(_1806_),
    ...
    .B1(_1984_),
    .Y(_1986_));
 sky130_fd_sc_hd__a211o_4 _5707_ (.A1(_1985_),
    .A2(_1986_),
    .B1(_1669_),
    .C1(_1672_),
    .X(_1988_));
 sky130_fd_sc_hd__o211ai_4 _5708_ (.A1(_1669_),
    ...
    .C1(_1986_),
    .Y(_1989_));
 sky130_fd_sc_hd__a211o_4 _5709_ (.A1(_1988_),
    .A2(_1989_),
    .B1(_1810_),
    .C1(_1812_),
    .X(_1990_));
 ...
 sky130_fd_sc_hd__or2_1 _5715_ (.A(_1994_),
    .B(_1995_),
    .X(_1996_));
 sky130_fd_sc_hd__and3_1 _5716_ (.A(_1828_),
    .B(_1819_),
    .C(_1996_),
    .X(_1997_));
 sky130_fd_sc_hd__a21oi_1 _5717_ (.A1(_1819_),
    ...
    .B1(_1996_),
    .Y(_1999_));
 sky130_fd_sc_hd__nor3_2 _5718_ (.A(net37),
    .B(_1999_),
    .C(_1997_),
 ...
 sky130_fd_sc_hd__xnor2_1 _5886_ (.A(\dsp.u_mac.acc_reg[30] ),
    .B(_2181_),
    .Y(_2183_));
 sky130_fd_sc_hd__a21oi_4 _5887_ (.A1(_2001_),
    .A2(_2000_),
    .B1(_2183_),
    .Y(_2185_));
 ...
 sky130_fd_sc_hd__xnor2_1 _6004_ (.A(_2186_),
    .B(_2311_),
    .Y(_2312_));
 sky130_fd_sc_hd__o21ai_2 _6005_ (.A1(_2185_),
    .A2(_2182_),
    .B1(_2312_),
    .Y(_2313_));
 sky130_fd_sc_hd__o311a_4 _6006_ (.A1(_2182_),
    .A2(_2185_),
    .A3(_2312_),
    .B1(net35),
    .C1(_2313_),
 ...
 sky130_fd_sc_hd__nand2_1 _6016_ (.A(net321),
 ...
 sky130_fd_sc_hd__xnor2_1 _6026_ (.A(\core.dsp_result_in[4] ),
    .B(_2325_),
    .Y(net28));
 sky130_fd_sc_hd__a31o_1 _6027_ (.A1(net319),
    .A2(_2525_),
    .A3(_2543_),
    .B1(net36),
    .X(_2327_));
 ...
 sky130_fd_sc_hd__xnor2_1 _6029_ (.A(\core.inst_addr_out[5] ),
    .B(net91),
    .Y(_2328_));
 sky130_fd_sc_hd__xnor2_2 _6030_ (.A(_2328_),
    .B(\core.dsp_result_in[5] ),
    .Y(net29));
 ...
 sky130_fd_sc_hd__xnor2_1 _6033_ (.A(\core.inst_addr_out[6] ),
    .B(net82),
    .Y(_2330_));
 sky130_fd_sc_hd__xnor2_2 _6034_ (.A(_2330_),
    .B(\core.dsp_result_in[6] ),
    .Y(net30));
 sky130_fd_sc_hd__xor2_1 _6035_ (.A(_2517_),
    .B(_2546_),
    .X(_2331_));
 sky130_fd_sc_hd__nor2_2 _6036_ (.A(net36),
    .B(_2331_),
 ...
 sky130_fd_sc_hd__xnor2_1 _6039_ (.A(\core.inst_addr_out[8] ),
    .B(net67),
    .Y(_2334_));
 sky130_fd_sc_hd__xnor2_2 _6040_ (.A(_2334_),
    .B(\core.dsp_result_in[8] ),
    .Y(net32));
 sky130_fd_sc_hd__xnor2_1 _6041_ (.A(\core.inst_addr_out[9] ),
    .B(net64),
    .Y(_2335_));
 sky130_fd_sc_hd__xnor2_2 _6042_ (.A(_2335_),
    .B(\core.dsp_result_in[9] ),
    .Y(net33));
 sky130_fd_sc_hd__xnor2_1 _6043_ (.A(\core.inst_addr_out[10] ),
    .B(net61),
    .Y(_2336_));
 sky130_fd_sc_hd__xnor2_2 _6044_ (.A(_2336_),
    .B(\core.dsp_result_in[10] ),
    .Y(net3));
 ...
 sky130_fd_sc_hd__xnor2_1 _6047_ (.A(\core.inst_addr_out[12] ),
    .B(net56),
    .Y(_2339_));
 sky130_fd_sc_hd__xnor2_1 _6048_ (.A(_2339_),
    .B(\core.dsp_result_in[12] ),
    .Y(net5));
 ...
 sky130_fd_sc_hd__xnor2_1 _6051_ (.A(\core.inst_addr_out[14] ),
    .B(net52),
    .Y(_2341_));
 sky130_fd_sc_hd__xnor2_1 _6052_ (.A(_2341_),
    .B(\core.dsp_result_in[14] ),
    .Y(net7));
 ...
 sky130_fd_sc_hd__xnor2_1 _6055_ (.A(\core.inst_addr_out[16] ),
    .B(_0133_),
    .Y(_2343_));
 sky130_fd_sc_hd__xnor2_1 _6056_ (.A(_2343_),
    .B(\core.dsp_result_in[16] ),
    .Y(net9));
 ...
 sky130_fd_sc_hd__xnor2_1 _6059_ (.A(\core.inst_addr_out[18] ),
    .B(_0322_),
    .Y(_2346_));
 sky130_fd_sc_hd__xnor2_1 _6060_ (.A(_2346_),
    .B(\core.dsp_result_in[18] ),
    .Y(net11));
 sky130_fd_sc_hd__xnor2_1 _6061_ (.A(\core.inst_addr_out[19] ),
    .B(_0429_),
    .Y(_2347_));
 sky130_fd_sc_hd__xnor2_2 _6062_ (.A(_2347_),
    .B(\core.dsp_result_in[19] ),
    .Y(net12));
 ...
 sky130_fd_sc_hd__xnor2_1 _6067_ (.A(\core.inst_addr_out[22] ),
    .B(_0774_),
    .Y(_2351_));
 sky130_fd_sc_hd__xnor2_2 _6068_ (.A(_2351_),
    .B(\core.dsp_result_in[22] ),
    .Y(net16));
 ...
 sky130_fd_sc_hd__xor2_1 _6073_ (.A(\core.inst_addr_out[25] ),
    .B(_1187_),
    .X(_2354_));
 sky130_fd_sc_hd__xnor2_4 _6074_ (.A(_2354_),
    .B(\core.dsp_result_in[25] ),
    .Y(net19));
 sky130_fd_sc_hd__xor2_1 _6075_ (.A(\core.inst_addr_out[26] ),
    .B(_1336_),
    .X(_2355_));
 sky130_fd_sc_hd__xnor2_2 _6076_ (.A(_2355_),
    .B(\core.dsp_result_in[26] ),
    .Y(net20));
 ...
 sky130_fd_sc_hd__xor2_1 _6079_ (.A(\core.inst_addr_out[28] ),
    .B(_1655_),
    .X(_2358_));
 sky130_fd_sc_hd__xnor2_2 _6080_ (.A(_2358_),
    .B(\core.dsp_result_in[28] ),
    .Y(net22));
 ...
 sky130_fd_sc_hd__xor2_1 _6085_ (.A(\core.inst_addr_out[31] ),
    .B(_2200_),
    .X(_2361_));
 sky130_fd_sc_hd__xnor2_2 _6086_ (.A(_2361_),
    .B(\core.dsp_result_in[31] ),
    .Y(net26));
 sky130_fd_sc_hd__or2_2 _6087_ (.A(net321),
    .B(\core.u_fetch.next_pc[2] ),
    .X(_2363_));
 sky130_fd_sc_hd__nand2_1 _6088_ (.A(_2319_),
    .B(net40),
    .Y(\core.u_fetch.next_pc[3] ));
 sky130_fd_sc_hd__and3_1 _6089_ (.A(\core.inst_addr_out[2] ),
    .B(net282),
    .C(\core.inst_addr_out[4] ),
    .X(_2364_));
 sky130_fd_sc_hd__a21oi_1 _6090_ (.A1(net282),
 ...
 sky130_fd_sc_hd__and2_1 _6092_ (.A(\core.inst_addr_out[5] ),
    .B(_2364_),
    .X(_2366_));
 sky130_fd_sc_hd__nor2_1 _6093_ (.A(net412),
    .B(_2364_),
    .Y(_2367_));
 sky130_fd_sc_hd__nor2_1 _6094_ (.A(_2366_),
    .B(_2367_),
    .Y(\core.u_fetch.next_pc[5] ));
 sky130_fd_sc_hd__xor2_1 _6095_ (.A(net395),
    .B(_2366_),
 ...
 sky130_fd_sc_hd__and2_1 _6099_ (.A(\core.inst_addr_out[8] ),
    .B(_2368_),
    .X(_2371_));
 sky130_fd_sc_hd__nor2_1 _6100_ (.A(net409),
    .B(_2368_),
    .Y(_2372_));
 sky130_fd_sc_hd__nor2_1 _6101_ (.A(_2371_),
    .B(_2372_),
    .Y(\core.u_fetch.next_pc[8] ));
 sky130_fd_sc_hd__xor2_1 _6102_ (.A(net394),
    .B(_2371_),
 ...
 sky130_fd_sc_hd__and2_1 _6106_ (.A(\core.inst_addr_out[11] ),
    .B(_2373_),
    .X(_2375_));
 sky130_fd_sc_hd__nor2_1 _6107_ (.A(net408),
    .B(_2373_),
    .Y(_2377_));
 sky130_fd_sc_hd__nor2_1 _6108_ (.A(_2375_),
    .B(_2377_),
    .Y(\core.u_fetch.next_pc[11] ));
 sky130_fd_sc_hd__xor2_1 _6109_ (.A(net402),
    .B(_2375_),
 ...
 sky130_fd_sc_hd__and2_4 _6113_ (.A(\core.inst_addr_out[14] ),
    .B(_2378_),
    .X(_2380_));
 sky130_fd_sc_hd__nor2_1 _6114_ (.A(net415),
    .B(_2378_),
    .Y(_2381_));
 sky130_fd_sc_hd__nor2_1 _6115_ (.A(_2380_),
    .B(_2381_),
    .Y(\core.u_fetch.next_pc[14] ));
 sky130_fd_sc_hd__xor2_1 _6116_ (.A(net390),
    .B(_2380_),
 ...
 sky130_fd_sc_hd__and2_4 _6120_ (.A(\core.inst_addr_out[17] ),
    .B(_2383_),
    .X(_2385_));
 sky130_fd_sc_hd__nor2_1 _6121_ (.A(net414),
    .B(_2383_),
    .Y(_2386_));
 sky130_fd_sc_hd__nor2_1 _6122_ (.A(_2385_),
    .B(_2386_),
    .Y(\core.u_fetch.next_pc[17] ));
 sky130_fd_sc_hd__xor2_1 _6123_ (.A(net393),
    .B(_2385_),
 ...
 sky130_fd_sc_hd__and2_1 _6127_ (.A(\core.inst_addr_out[20] ),
    .B(_2387_),
    .X(_2390_));
 sky130_fd_sc_hd__nor2_1 _6128_ (.A(net413),
    .B(_2387_),
    .Y(_2391_));
 sky130_fd_sc_hd__nor2_1 _6129_ (.A(_2390_),
    .B(_2391_),
    .Y(\core.u_fetch.next_pc[20] ));
 sky130_fd_sc_hd__xor2_1 _6130_ (.A(net404),
    .B(_2390_),
 ...
 sky130_fd_sc_hd__and2_1 _6134_ (.A(\core.inst_addr_out[23] ),
    .B(_2392_),
    .X(_2394_));
 sky130_fd_sc_hd__nor2_1 _6135_ (.A(net405),
    .B(_2392_),
    .Y(_2395_));
 sky130_fd_sc_hd__nor2_1 _6136_ (.A(_2394_),
    .B(_2395_),
    .Y(\core.u_fetch.next_pc[23] ));
 sky130_fd_sc_hd__xor2_1 _6137_ (.A(net401),
    .B(_2394_),
 ...
 sky130_fd_sc_hd__and2_1 _6141_ (.A(\core.inst_addr_out[26] ),
    .B(_2397_),
    .X(_2399_));
 sky130_fd_sc_hd__nor2_1 _6142_ (.A(net416),
    .B(_2397_),
    .Y(_2400_));
 sky130_fd_sc_hd__nor2_1 _6143_ (.A(_2399_),
    .B(_2400_),
    .Y(\core.u_fetch.next_pc[26] ));
 sky130_fd_sc_hd__xor2_1 _6144_ (.A(net389),
    .B(_2399_),
    .X(\core.u_fetch.next_pc[27] ));
 sky130_fd_sc_hd__and3_1 _6145_ (.A(_2399_),
    .B(\core.inst_addr_out[28] ),
    .C(\core.inst_addr_out[27] ),
    .X(_2401_));
 ...
 sky130_fd_sc_hd__xor2_1 _6148_ (.A(net407),
    .B(_2401_),
 ...
 sky130_fd_sc_hd__xor2_1 _6152_ (.A(net388),
    .B(_2404_),
 ...
 sky130_fd_sc_hd__and2_1 _6173_ (.A(net184),
    .B(net44),
    .X(_0019_));
 sky130_fd_sc_hd__and2_1 _6174_ (.A(net385),
    .B(net44),
    .X(_0020_));
 sky130_fd_sc_hd__and2_1 _6175_ (.A(net418),
    .B(net44),
    .X(_0021_));
 ...
 sky130_fd_sc_hd__and2_1 _6183_ (.A(\core.u_regfile.registers[1][29] ),
    .B(net45),
    .X(_0029_));
 sky130_fd_sc_hd__and2_1 _6184_ (.A(net403),
    .B(net44),
    .X(_0030_));
 sky130_fd_sc_hd__and2_1 _6185_ (.A(net386),
    .B(net44),
    .X(_0031_));
 ...
 sky130_fd_sc_hd__and2_1 _6215_ (.A(\core.u_regfile.registers[2][29] ),
    .B(net39),
    .X(_0061_));
 sky130_fd_sc_hd__and2_1 _6216_ (.A(net411),
    .B(net41),
    .X(_0062_));
 sky130_fd_sc_hd__and2_1 _6217_ (.A(net387),
    .B(net39),
    .X(_0063_));
 sky130_fd_sc_hd__dfrtp_4 _6218_ (.CLK(clknet_4_1_0_clk),
    .D(\core.u_fetch.next_pc[2] ),
    .RESET_B(net241),
    .Q(\core.inst_addr_out[2] ));
 sky130_fd_sc_hd__dfrtp_1 _6219_ (.CLK(clknet_4_1_0_clk),
    .D(\core.u_fetch.next_pc[3] ),
    .RESET_B(net241),
    .Q(\core.dsp_valid_out ));
 sky130_fd_sc_hd__dfrtp_1 _6220_ (.CLK(clknet_4_4_0_clk),
    .D(\core.u_fetch.next_pc[4] ),
    .RESET_B(net246),
    .Q(\core.inst_addr_out[4] ));
 sky130_fd_sc_hd__dfrtp_1 _6221_ (.CLK(clknet_4_5_0_clk),
    .D(\core.u_fetch.next_pc[5] ),
    .RESET_B(net246),
    .Q(\core.inst_addr_out[5] ));
 sky130_fd_sc_hd__dfrtp_1 _6222_ (.CLK(clknet_4_5_0_clk),
    .D(\core.u_fetch.next_pc[6] ),
    .RESET_B(net246),
    .Q(\core.inst_addr_out[6] ));
 sky130_fd_sc_hd__dfrtp_1 _6223_ (.CLK(clknet_4_5_0_clk),
    .D(\core.u_fetch.next_pc[7] ),
    .RESET_B(net246),
    .Q(\core.inst_addr_out[7] ));
 sky130_fd_sc_hd__dfrtp_1 _6224_ (.CLK(clknet_4_5_0_clk),
    .D(\core.u_fetch.next_pc[8] ),
    .RESET_B(net246),
    .Q(\core.inst_addr_out[8] ));
 sky130_fd_sc_hd__dfrtp_1 _6225_ (.CLK(clknet_4_7_0_clk),
    .D(\core.u_fetch.next_pc[9] ),
    .RESET_B(net247),
    .Q(\core.inst_addr_out[9] ));
 sky130_fd_sc_hd__dfrtp_1 _6226_ (.CLK(clknet_4_7_0_clk),
    .D(\core.u_fetch.next_pc[10] ),
    .RESET_B(net247),
    .Q(\core.inst_addr_out[10] ));
 sky130_fd_sc_hd__dfrtp_1 _6227_ (.CLK(clknet_4_6_0_clk),
    .D(\core.u_fetch.next_pc[11] ),
    .RESET_B(net248),
    .Q(\core.inst_addr_out[11] ));
 sky130_fd_sc_hd__dfrtp_1 _6228_ (.CLK(clknet_4_6_0_clk),
    .D(\core.u_fetch.next_pc[12] ),
    .RESET_B(net248),
    .Q(\core.inst_addr_out[12] ));
 sky130_fd_sc_hd__dfrtp_1 _6229_ (.CLK(clknet_4_6_0_clk),
    .D(\core.u_fetch.next_pc[13] ),
    .RESET_B(net248),
    .Q(\core.inst_addr_out[13] ));
 sky130_fd_sc_hd__dfrtp_1 _6230_ (.CLK(clknet_4_13_0_clk),
    .D(\core.u_fetch.next_pc[14] ),
    .RESET_B(net248),
    .Q(\core.inst_addr_out[14] ));
 sky130_fd_sc_hd__dfrtp_1 _6231_ (.CLK(clknet_4_13_0_clk),
    .D(\core.u_fetch.next_pc[15] ),
    .RESET_B(net253),
    .Q(\core.inst_addr_out[15] ));
 sky130_fd_sc_hd__dfrtp_1 _6232_ (.CLK(clknet_4_13_0_clk),
    .D(\core.u_fetch.next_pc[16] ),
    .RESET_B(net253),
    .Q(\core.inst_addr_out[16] ));
 sky130_fd_sc_hd__dfrtp_1 _6233_ (.CLK(clknet_4_13_0_clk),
    .D(\core.u_fetch.next_pc[17] ),
    .RESET_B(net253),
    .Q(\core.inst_addr_out[17] ));
 sky130_fd_sc_hd__dfrtp_1 _6234_ (.CLK(clknet_4_12_0_clk),
    .D(\core.u_fetch.next_pc[18] ),
    .RESET_B(net252),
    .Q(\core.inst_addr_out[18] ));
 sky130_fd_sc_hd__dfrtp_1 _6235_ (.CLK(clknet_4_12_0_clk),
    .D(\core.u_fetch.next_pc[19] ),
    .RESET_B(net252),
    .Q(\core.inst_addr_out[19] ));
 sky130_fd_sc_hd__dfrtp_1 _6236_ (.CLK(clknet_4_15_0_clk),
    .D(\core.u_fetch.next_pc[20] ),
    .RESET_B(net250),
    .Q(\core.inst_addr_out[20] ));
 sky130_fd_sc_hd__dfrtp_1 _6237_ (.CLK(clknet_4_15_0_clk),
    .D(\core.u_fetch.next_pc[21] ),
    .RESET_B(net250),
    .Q(\core.inst_addr_out[21] ));
 sky130_fd_sc_hd__dfrtp_1 _6238_ (.CLK(clknet_4_15_0_clk),
    .D(\core.u_fetch.next_pc[22] ),
    .RESET_B(net250),
    .Q(\core.inst_addr_out[22] ));
 sky130_fd_sc_hd__dfrtp_1 _6239_ (.CLK(clknet_4_14_0_clk),
    .D(\core.u_fetch.next_pc[23] ),
    .RESET_B(net250),
    .Q(\core.inst_addr_out[23] ));
 sky130_fd_sc_hd__dfrtp_1 _6240_ (.CLK(clknet_4_14_0_clk),
    .D(\core.u_fetch.next_pc[24] ),
    .RESET_B(net251),
    .Q(\core.inst_addr_out[24] ));
 sky130_fd_sc_hd__dfrtp_1 _6241_ (.CLK(clknet_4_15_0_clk),
    .D(\core.u_fetch.next_pc[25] ),
    .RESET_B(net251),
    .Q(\core.inst_addr_out[25] ));
 sky130_fd_sc_hd__dfrtp_1 _6242_ (.CLK(clknet_4_14_0_clk),
    .D(\core.u_fetch.next_pc[26] ),
    .RESET_B(net251),
    .Q(\core.inst_addr_out[26] ));
 sky130_fd_sc_hd__dfrtp_2 _6243_ (.CLK(clknet_4_15_0_clk),
    .D(\core.u_fetch.next_pc[27] ),
    .RESET_B(net251),
    .Q(\core.inst_addr_out[27] ));
 sky130_fd_sc_hd__dfrtp_1 _6244_ (.CLK(clknet_4_14_0_clk),
    .D(\core.u_fetch.next_pc[28] ),
    .RESET_B(net251),
    .Q(\core.inst_addr_out[28] ));
 sky130_fd_sc_hd__dfrtp_1 _6245_ (.CLK(clknet_4_14_0_clk),
    .D(\core.u_fetch.next_pc[29] ),
    .RESET_B(net250),
    .Q(\core.inst_addr_out[29] ));
 sky130_fd_sc_hd__dfrtp_1 _6246_ (.CLK(clknet_4_14_0_clk),
    .D(\core.u_fetch.next_pc[30] ),
    .RESET_B(net250),
    .Q(\core.inst_addr_out[30] ));
 sky130_fd_sc_hd__dfrtp_1 _6247_ (.CLK(clknet_4_14_0_clk),
    .D(\core.u_fetch.next_pc[31] ),
    .RESET_B(net250),
    .Q(\core.inst_addr_out[31] ));
 sky130_fd_sc_hd__dfrtp_4 _6248_ (.CLK(clknet_4_1_0_clk),
    .D(_0000_),
    .RESET_B(net239),
    .Q(\core.u_regfile.registers[1][0] ));
 sky130_fd_sc_hd__dfrtp_1 _6249_ (.CLK(clknet_4_1_0_clk),
    .D(_0001_),
    .RESET_B(net239),
    .Q(\core.u_regfile.registers[1][1] ));
 sky130_fd_sc_hd__dfrtp_2 _6250_ (.CLK(clknet_4_1_0_clk),
    .D(_0002_),
    .RESET_B(net241),
    .Q(\core.u_regfile.registers[1][2] ));
 sky130_fd_sc_hd__dfrtp_2 _6251_ (.CLK(clknet_4_0_0_clk),
    .D(_0003_),
    .RESET_B(net239),
    .Q(\core.u_regfile.registers[1][3] ));
 sky130_fd_sc_hd__dfrtp_4 _6252_ (.CLK(clknet_4_0_0_clk),
    .D(_0004_),
    .RESET_B(net239),
    .Q(\core.u_regfile.registers[1][4] ));
 sky130_fd_sc_hd__dfrtp_1 _6253_ (.CLK(clknet_4_0_0_clk),
    .D(_0005_),
    .RESET_B(net239),
    .Q(\core.u_regfile.registers[1][5] ));
 sky130_fd_sc_hd__dfrtp_4 _6254_ (.CLK(clknet_4_0_0_clk),
    .D(_0006_),
    .RESET_B(net239),
    .Q(\core.u_regfile.registers[1][6] ));
 sky130_fd_sc_hd__dfrtp_4 _6255_ (.CLK(clknet_4_2_0_clk),
    .D(_0007_),
    .RESET_B(net239),
    .Q(\core.u_regfile.registers[1][7] ));
 sky130_fd_sc_hd__dfrtp_4 _6256_ (.CLK(clknet_4_0_0_clk),
    .D(_0008_),
    .RESET_B(net240),
    .Q(\core.u_regfile.registers[1][8] ));
 sky130_fd_sc_hd__dfrtp_4 _6257_ (.CLK(clknet_4_3_0_clk),
    .D(_0009_),
    .RESET_B(net244),
    .Q(\core.u_regfile.registers[1][9] ));
 sky130_fd_sc_hd__dfrtp_4 _6258_ (.CLK(clknet_4_2_0_clk),
    .D(_0010_),
    .RESET_B(net240),
    .Q(\core.u_regfile.registers[1][10] ));
 sky130_fd_sc_hd__dfrtp_4 _6259_ (.CLK(clknet_4_2_0_clk),
    .D(_0011_),
    .RESET_B(net240),
    .Q(\core.u_regfile.registers[1][11] ));
 sky130_fd_sc_hd__dfrtp_4 _6260_ (.CLK(clknet_4_2_0_clk),
    .D(_0012_),
    .RESET_B(net244),
    .Q(\core.u_regfile.registers[1][12] ));
 sky130_fd_sc_hd__dfrtp_4 _6261_ (.CLK(clknet_4_3_0_clk),
    .D(_0013_),
    .RESET_B(net245),
    .Q(\core.u_regfile.registers[1][13] ));
 sky130_fd_sc_hd__dfrtp_4 _6262_ (.CLK(clknet_4_6_0_clk),
    .D(_0014_),
    .RESET_B(net254),
    .Q(\core.u_regfile.registers[1][14] ));
 sky130_fd_sc_hd__dfrtp_1 _6263_ (.CLK(clknet_4_9_0_clk),
    .D(_0015_),
    .RESET_B(net249),
    .Q(\core.u_regfile.registers[1][15] ));
 sky130_fd_sc_hd__dfrtp_4 _6264_ (.CLK(clknet_4_9_0_clk),
    .D(_0016_),
    .RESET_B(net249),
    .Q(\core.u_regfile.registers[1][16] ));
 sky130_fd_sc_hd__dfrtp_1 _6265_ (.CLK(clknet_4_9_0_clk),
    .D(_0017_),
    .RESET_B(net249),
    .Q(\core.u_regfile.registers[1][17] ));
 sky130_fd_sc_hd__dfrtp_1 _6266_ (.CLK(clknet_4_9_0_clk),
    .D(_0018_),
    .RESET_B(net249),
    .Q(\core.u_regfile.registers[1][18] ));
 sky130_fd_sc_hd__dfrtp_1 _6267_ (.CLK(clknet_4_8_0_clk),
    .D(_0019_),
    .RESET_B(net249),
    .Q(\core.u_regfile.registers[1][19] ));
 sky130_fd_sc_hd__dfrtp_1 _6268_ (.CLK(clknet_4_8_0_clk),
    .D(_0020_),
    .RESET_B(net254),
    .Q(\core.u_regfile.registers[1][20] ));
 sky130_fd_sc_hd__dfrtp_2 _6269_ (.CLK(clknet_4_8_0_clk),
    .D(_0021_),
    .RESET_B(net254),
    .Q(\core.u_regfile.registers[1][21] ));
 sky130_fd_sc_hd__dfrtp_1 _6270_ (.CLK(clknet_4_8_0_clk),
    .D(_0022_),
    .RESET_B(net254),
    .Q(\core.u_regfile.registers[1][22] ));
 sky130_fd_sc_hd__dfrtp_2 _6271_ (.CLK(clknet_4_10_0_clk),
    .D(_0023_),
    .RESET_B(net254),
    .Q(\core.u_regfile.registers[1][23] ));
 sky130_fd_sc_hd__dfrtp_1 _6272_ (.CLK(clknet_4_10_0_clk),
    .D(_0024_),
    .RESET_B(net254),
    .Q(\core.u_regfile.registers[1][24] ));
 sky130_fd_sc_hd__dfrtp_4 _6273_ (.CLK(clknet_4_10_0_clk),
    .D(_0025_),
    .RESET_B(net254),
    .Q(\core.u_regfile.registers[1][25] ));
 sky130_fd_sc_hd__dfrtp_4 _6274_ (.CLK(clknet_4_10_0_clk),
    .D(_0026_),
    .RESET_B(net254),
    .Q(\core.u_regfile.registers[1][26] ));
 sky130_fd_sc_hd__dfrtp_2 _6275_ (.CLK(clknet_4_10_0_clk),
    .D(_0027_),
    .RESET_B(net254),
    .Q(\core.u_regfile.registers[1][27] ));
 sky130_fd_sc_hd__dfrtp_2 _6276_ (.CLK(clknet_4_11_0_clk),
    .D(_0028_),
    .RESET_B(net249),
    .Q(\core.u_regfile.registers[1][28] ));
 sky130_fd_sc_hd__dfrtp_1 _6277_ (.CLK(clknet_4_11_0_clk),
    .D(_0029_),
    .RESET_B(net249),
    .Q(\core.u_regfile.registers[1][29] ));
 sky130_fd_sc_hd__dfrtp_1 _6278_ (.CLK(clknet_4_11_0_clk),
    .D(_0030_),
    .RESET_B(net249),
    .Q(\core.u_regfile.registers[1][30] ));
 sky130_fd_sc_hd__dfrtp_1 _6279_ (.CLK(clknet_4_10_0_clk),
    .D(_0031_),
    .RESET_B(net249),
    .Q(\core.u_regfile.registers[1][31] ));
 sky130_fd_sc_hd__dfrtp_2 _6280_ (.CLK(clknet_4_4_0_clk),
    .D(_0032_),
    .RESET_B(net241),
    .Q(\core.u_regfile.registers[2][0] ));
 sky130_fd_sc_hd__dfrtp_1 _6281_ (.CLK(clknet_4_4_0_clk),
    .D(_0033_),
    .RESET_B(net241),
    .Q(\core.u_regfile.registers[2][1] ));
 sky130_fd_sc_hd__dfrtp_1 _6282_ (.CLK(clknet_4_4_0_clk),
    .D(_0034_),
    .RESET_B(net241),
    .Q(\core.u_regfile.registers[2][2] ));
 sky130_fd_sc_hd__dfrtp_4 _6283_ (.CLK(clknet_4_1_0_clk),
    .D(_0035_),
    .RESET_B(net241),
    .Q(\core.u_regfile.registers[2][3] ));
 sky130_fd_sc_hd__dfrtp_4 _6284_ (.CLK(clknet_4_4_0_clk),
    .D(_0036_),
    .RESET_B(net241),
    .Q(\core.u_regfile.registers[2][4] ));
 sky130_fd_sc_hd__dfrtp_1 _6285_ (.CLK(clknet_4_1_0_clk),
    .D(_0037_),
    .RESET_B(net241),
    .Q(\core.u_regfile.registers[2][5] ));
 sky130_fd_sc_hd__dfrtp_1 _6286_ (.CLK(clknet_4_1_0_clk),
    .D(_0038_),
    .RESET_B(net241),
    .Q(\core.u_regfile.registers[2][6] ));
 sky130_fd_sc_hd__dfrtp_1 _6287_ (.CLK(clknet_4_1_0_clk),
    .D(_0039_),
    .RESET_B(net242),
    .Q(\core.u_regfile.registers[2][7] ));
 sky130_fd_sc_hd__dfrtp_4 _6288_ (.CLK(clknet_4_1_0_clk),
    .D(_0040_),
    .RESET_B(net242),
    .Q(\core.u_regfile.registers[2][8] ));
 sky130_fd_sc_hd__dfrtp_1 _6289_ (.CLK(clknet_4_3_0_clk),
    .D(_0041_),
    .RESET_B(net245),
    .Q(\core.u_regfile.registers[2][9] ));
 sky130_fd_sc_hd__dfrtp_1 _6290_ (.CLK(clknet_4_7_0_clk),
    .D(_0042_),
    .RESET_B(net243),
    .Q(\core.u_regfile.registers[2][10] ));
 sky130_fd_sc_hd__dfrtp_4 _6291_ (.CLK(clknet_4_0_0_clk),
    .D(_0043_),
    .RESET_B(net240),
    .Q(\core.u_regfile.registers[2][11] ));
 sky130_fd_sc_hd__dfrtp_4 _6292_ (.CLK(clknet_4_2_0_clk),
    .D(_0044_),
    .RESET_B(net240),
    .Q(\core.u_regfile.registers[2][12] ));
 sky130_fd_sc_hd__dfrtp_1 _6293_ (.CLK(clknet_4_0_0_clk),
    .D(_0045_),
    .RESET_B(net240),
    .Q(\core.u_regfile.registers[2][13] ));
 sky130_fd_sc_hd__dfrtp_1 _6294_ (.CLK(clknet_4_0_0_clk),
    .D(_0046_),
    .RESET_B(net240),
    .Q(\core.u_regfile.registers[2][14] ));
 sky130_fd_sc_hd__dfrtp_4 _6295_ (.CLK(clknet_4_0_0_clk),
    .D(_0047_),
    .RESET_B(net240),
    .Q(\core.u_regfile.registers[2][15] ));
 sky130_fd_sc_hd__dfrtp_4 _6296_ (.CLK(clknet_4_0_0_clk),
    .D(_0048_),
    .RESET_B(net239),
    .Q(\core.u_regfile.registers[2][16] ));
 sky130_fd_sc_hd__dfrtp_2 _6297_ (.CLK(clknet_4_0_0_clk),
    .D(_0049_),
    .RESET_B(net239),
    .Q(\core.u_regfile.registers[2][17] ));
 sky130_fd_sc_hd__dfrtp_1 _6298_ (.CLK(clknet_4_0_0_clk),
    .D(_0050_),
    .RESET_B(net239),
    .Q(\core.u_regfile.registers[2][18] ));
 sky130_fd_sc_hd__dfrtp_1 _6299_ (.CLK(clknet_4_3_0_clk),
    .D(_0051_),
    .RESET_B(net245),
    .Q(\core.u_regfile.registers[2][19] ));
 sky130_fd_sc_hd__dfrtp_1 _6300_ (.CLK(clknet_4_3_0_clk),
    .D(_0052_),
    .RESET_B(net245),
    .Q(\core.u_regfile.registers[2][20] ));
 sky130_fd_sc_hd__dfrtp_1 _6301_ (.CLK(clknet_4_3_0_clk),
    .D(_0053_),
    .RESET_B(net245),
    .Q(\core.u_regfile.registers[2][21] ));
 sky130_fd_sc_hd__dfrtp_1 _6302_ (.CLK(clknet_4_2_0_clk),
    .D(_0054_),
    .RESET_B(net244),
    .Q(\core.u_regfile.registers[2][22] ));
 sky130_fd_sc_hd__dfrtp_4 _6303_ (.CLK(clknet_4_2_0_clk),
    .D(_0055_),
    .RESET_B(net244),
    .Q(\core.u_regfile.registers[2][23] ));
 sky130_fd_sc_hd__dfrtp_1 _6304_ (.CLK(clknet_4_2_0_clk),
    .D(_0056_),
    .RESET_B(net244),
    .Q(\core.u_regfile.registers[2][24] ));
 sky130_fd_sc_hd__dfrtp_2 _6305_ (.CLK(clknet_4_2_0_clk),
    .D(_0057_),
    .RESET_B(net244),
    .Q(\core.u_regfile.registers[2][25] ));
 sky130_fd_sc_hd__dfrtp_1 _6306_ (.CLK(clknet_4_2_0_clk),
    .D(_0058_),
    .RESET_B(net244),
    .Q(\core.u_regfile.registers[2][26] ));
 sky130_fd_sc_hd__dfrtp_4 _6307_ (.CLK(clknet_4_2_0_clk),
    .D(_0059_),
    .RESET_B(net244),
    .Q(\core.u_regfile.registers[2][27] ));
 sky130_fd_sc_hd__dfrtp_4 _6308_ (.CLK(clknet_4_3_0_clk),
    .D(_0060_),
    .RESET_B(net245),
    .Q(\core.u_regfile.registers[2][28] ));
 sky130_fd_sc_hd__dfrtp_2 _6309_ (.CLK(clknet_4_3_0_clk),
    .D(_0061_),
    .RESET_B(net244),
    .Q(\core.u_regfile.registers[2][29] ));
 sky130_fd_sc_hd__dfrtp_1 _6310_ (.CLK(clknet_4_3_0_clk),
    .D(_0062_),
    .RESET_B(net245),
    .Q(\core.u_regfile.registers[2][30] ));
 sky130_fd_sc_hd__dfrtp_1 _6311_ (.CLK(clknet_4_3_0_clk),
    .D(_0063_),
    .RESET_B(net244),
    .Q(\core.u_regfile.registers[2][31] ));
 sky130_fd_sc_hd__dfrtp_1 _6312_ (.CLK(clknet_4_1_0_clk),
    .D(\core.dsp_result_in[0] ),
    .RESET_B(net242),
    .Q(\dsp.u_mac.acc_reg[0] ));
 sky130_fd_sc_hd__dfrtp_1 _6313_ (.CLK(clknet_4_4_0_clk),
    .D(\core.dsp_result_in[1] ),
    .RESET_B(net242),
    .Q(\dsp.u_mac.acc_reg[1] ));
 sky130_fd_sc_hd__dfrtp_1 _6314_ (.CLK(clknet_4_4_0_clk),
    .D(\core.dsp_result_in[2] ),
    .RESET_B(net242),
    .Q(\dsp.u_mac.acc_reg[2] ));
 sky130_fd_sc_hd__dfrtp_1 _6315_ (.CLK(clknet_4_4_0_clk),
    .D(\core.dsp_result_in[3] ),
    .RESET_B(net248),
    .Q(\dsp.u_mac.acc_reg[3] ));
 sky130_fd_sc_hd__dfrtp_1 _6316_ (.CLK(clknet_4_5_0_clk),
    .D(\core.dsp_result_in[4] ),
    .RESET_B(net246),
    .Q(\dsp.u_mac.acc_reg[4] ));
 sky130_fd_sc_hd__dfrtp_1 _6317_ (.CLK(clknet_4_5_0_clk),
    .D(\core.dsp_result_in[5] ),
    .RESET_B(net246),
    .Q(\dsp.u_mac.acc_reg[5] ));
 sky130_fd_sc_hd__dfrtp_1 _6318_ (.CLK(clknet_4_5_0_clk),
    .D(\core.dsp_result_in[6] ),
    .RESET_B(net246),
    .Q(\dsp.u_mac.acc_reg[6] ));
 sky130_fd_sc_hd__dfrtp_1 _6319_ (.CLK(clknet_4_5_0_clk),
    .D(\core.dsp_result_in[7] ),
    .RESET_B(net246),
    .Q(\dsp.u_mac.acc_reg[7] ));
 sky130_fd_sc_hd__dfrtp_1 _6320_ (.CLK(clknet_4_5_0_clk),
    .D(\core.dsp_result_in[8] ),
    .RESET_B(net246),
    .Q(\dsp.u_mac.acc_reg[8] ));
 sky130_fd_sc_hd__dfrtp_1 _6321_ (.CLK(clknet_4_5_0_clk),
    .D(\core.dsp_result_in[9] ),
    .RESET_B(net247),
    .Q(\dsp.u_mac.acc_reg[9] ));
 sky130_fd_sc_hd__dfrtp_1 _6322_ (.CLK(clknet_4_7_0_clk),
    .D(\core.dsp_result_in[10] ),
    .RESET_B(net247),
    .Q(\dsp.u_mac.acc_reg[10] ));
 sky130_fd_sc_hd__dfrtp_1 _6323_ (.CLK(clknet_4_7_0_clk),
    .D(\core.dsp_result_in[11] ),
    .RESET_B(net247),
    .Q(\dsp.u_mac.acc_reg[11] ));
 sky130_fd_sc_hd__dfrtp_1 _6324_ (.CLK(clknet_4_7_0_clk),
    .D(\core.dsp_result_in[12] ),
    .RESET_B(net247),
    .Q(\dsp.u_mac.acc_reg[12] ));
 sky130_fd_sc_hd__dfrtp_1 _6325_ (.CLK(clknet_4_6_0_clk),
    .D(\core.dsp_result_in[13] ),
    .RESET_B(net248),
    .Q(\dsp.u_mac.acc_reg[13] ));
 sky130_fd_sc_hd__dfrtp_1 _6326_ (.CLK(clknet_4_13_0_clk),
    .D(\core.dsp_result_in[14] ),
    .RESET_B(net248),
    .Q(\dsp.u_mac.acc_reg[14] ));
 sky130_fd_sc_hd__dfrtp_1 _6327_ (.CLK(clknet_4_13_0_clk),
    .D(\core.dsp_result_in[15] ),
    .RESET_B(net248),
    .Q(\dsp.u_mac.acc_reg[15] ));
 sky130_fd_sc_hd__dfrtp_1 _6328_ (.CLK(clknet_4_13_0_clk),
    .D(\core.dsp_result_in[16] ),
    .RESET_B(net253),
    .Q(\dsp.u_mac.acc_reg[16] ));
 sky130_fd_sc_hd__dfrtp_1 _6329_ (.CLK(clknet_4_12_0_clk),
    .D(\core.dsp_result_in[17] ),
    .RESET_B(net253),
    .Q(\dsp.u_mac.acc_reg[17] ));
 sky130_fd_sc_hd__dfrtp_1 _6330_ (.CLK(clknet_4_12_0_clk),
    .D(\core.dsp_result_in[18] ),
    .RESET_B(net253),
    .Q(\dsp.u_mac.acc_reg[18] ));
 sky130_fd_sc_hd__dfrtp_1 _6331_ (.CLK(clknet_4_12_0_clk),
    .D(\core.dsp_result_in[19] ),
    .RESET_B(net253),
    .Q(\dsp.u_mac.acc_reg[19] ));
 sky130_fd_sc_hd__dfrtp_1 _6332_ (.CLK(clknet_4_15_0_clk),
    .D(\core.dsp_result_in[20] ),
    .RESET_B(net252),
    .Q(\dsp.u_mac.acc_reg[20] ));
 sky130_fd_sc_hd__dfrtp_1 _6333_ (.CLK(clknet_4_15_0_clk),
    .D(\core.dsp_result_in[21] ),
    .RESET_B(net252),
    .Q(\dsp.u_mac.acc_reg[21] ));
 sky130_fd_sc_hd__dfrtp_1 _6334_ (.CLK(clknet_4_12_0_clk),
    .D(\core.dsp_result_in[22] ),
    .RESET_B(net252),
    .Q(\dsp.u_mac.acc_reg[22] ));
 sky130_fd_sc_hd__dfrtp_1 _6335_ (.CLK(clknet_4_15_0_clk),
    .D(\core.dsp_result_in[23] ),
    .RESET_B(net252),
    .Q(\dsp.u_mac.acc_reg[23] ));
 sky130_fd_sc_hd__dfrtp_1 _6336_ (.CLK(clknet_4_15_0_clk),
    .D(\core.dsp_result_in[24] ),
    .RESET_B(net251),
    .Q(\dsp.u_mac.acc_reg[24] ));
 sky130_fd_sc_hd__dfrtp_1 _6337_ (.CLK(clknet_4_14_0_clk),
    .D(\core.dsp_result_in[25] ),
    .RESET_B(net250),
    .Q(\dsp.u_mac.acc_reg[25] ));
 sky130_fd_sc_hd__dfrtp_1 _6338_ (.CLK(clknet_4_14_0_clk),
    .D(\core.dsp_result_in[26] ),
    .RESET_B(net252),
    .Q(\dsp.u_mac.acc_reg[26] ));
 sky130_fd_sc_hd__dfrtp_1 _6339_ (.CLK(clknet_4_9_0_clk),
    .D(\core.dsp_result_in[27] ),
    .RESET_B(net252),
    .Q(\dsp.u_mac.acc_reg[27] ));
 sky130_fd_sc_hd__dfrtp_1 _6340_ (.CLK(clknet_4_11_0_clk),
    .D(\core.dsp_result_in[28] ),
    .RESET_B(net250),
    .Q(\dsp.u_mac.acc_reg[28] ));
 sky130_fd_sc_hd__dfrtp_1 _6341_ (.CLK(clknet_4_11_0_clk),
    .D(\core.dsp_result_in[29] ),
    .RESET_B(net250),
    .Q(\dsp.u_mac.acc_reg[29] ));
 sky130_fd_sc_hd__dfrtp_1 _6342_ (.CLK(clknet_4_11_0_clk),
    .D(\core.dsp_result_in[30] ),
    .RESET_B(net249),
    .Q(\dsp.u_mac.acc_reg[30] ));
 sky130_fd_sc_hd__dfrtp_1 _6343_ (.CLK(clknet_4_11_0_clk),
 ...
 sky130_fd_sc_hd__clkbuf_4 output2 (.A(net2),
    .X(monitor_out[0]));
 sky130_fd_sc_hd__buf_6 output3 (.A(net3),
    .X(monitor_out[10]));
 sky130_fd_sc_hd__buf_6 output4 (.A(net4),
    .X(monitor_out[11]));
 sky130_fd_sc_hd__buf_6 output5 (.A(net5),
    .X(monitor_out[12]));
 sky130_fd_sc_hd__buf_4 output6 (.A(net6),
    .X(monitor_out[13]));
 sky130_fd_sc_hd__buf_6 output7 (.A(net7),
    .X(monitor_out[14]));
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout35 (.A(_2609_),
    .X(net35));
 sky130_fd_sc_hd__buf_8 fanout36 (.A(_2608_),
    .X(net36));
 sky130_fd_sc_hd__buf_2 fanout37 (.A(net384),
    .X(net37));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout76 (.A(net77),
    .X(net76));
 sky130_fd_sc_hd__buf_8 fanout77 (.A(_2369_),
    .X(net77));
 ...
 sky130_fd_sc_hd__buf_2 fanout81 (.A(net82),
    .X(net81));
 sky130_fd_sc_hd__buf_6 fanout82 (.A(_2271_),
    .X(net82));
 ...
 sky130_fd_sc_hd__buf_12 fanout88 (.A(net89),
    .X(net88));
 sky130_fd_sc_hd__buf_8 fanout89 (.A(_2096_),
    .X(net89));
 sky130_fd_sc_hd__buf_4 fanout90 (.A(net91),
    .X(net90));
 sky130_fd_sc_hd__buf_8 fanout91 (.A(_2074_),
    .X(net91));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout94 (.A(net95),
    .X(net94));
 sky130_fd_sc_hd__buf_4 fanout95 (.A(_2019_),
    .X(net95));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout103 (.A(net105),
    .X(net103));
 sky130_fd_sc_hd__buf_12 fanout104 (.A(net105),
    .X(net104));
 sky130_fd_sc_hd__buf_12 fanout105 (.A(_1932_),
    .X(net105));
 ...
 sky130_fd_sc_hd__buf_6 fanout167 (.A(net168),
    .X(net167));
 sky130_fd_sc_hd__buf_12 fanout168 (.A(\core.u_regfile.registers[2][3] ),
    .X(net168));
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout197 (.A(\core.u_regfile.registers[1][5] ),
    .X(net197));
 sky130_fd_sc_hd__buf_4 fanout198 (.A(\core.u_regfile.registers[1][4] ),
    .X(net198));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout205 (.A(\core.u_regfile.registers[1][0] ),
    .X(net205));
 sky130_fd_sc_hd__buf_6 fanout206 (.A(net214),
    .X(net206));
 sky130_fd_sc_hd__clkbuf_2 fanout207 (.A(net214),
    .X(net207));
 sky130_fd_sc_hd__buf_8 fanout208 (.A(net209),
    .X(net208));
 sky130_fd_sc_hd__buf_8 fanout209 (.A(net214),
    .X(net209));
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout213 (.A(net214),
    .X(net213));
 sky130_fd_sc_hd__buf_8 fanout214 (.A(net238),
    .X(net214));
 sky130_fd_sc_hd__buf_6 fanout215 (.A(net217),
    .X(net215));
 sky130_fd_sc_hd__buf_8 fanout216 (.A(net217),
    .X(net216));
 sky130_fd_sc_hd__buf_8 fanout217 (.A(net220),
    .X(net217));
 sky130_fd_sc_hd__buf_8 fanout218 (.A(net219),
    .X(net218));
 sky130_fd_sc_hd__buf_8 fanout219 (.A(net220),
    .X(net219));
 sky130_fd_sc_hd__buf_8 fanout220 (.A(net238),
    .X(net220));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout237 (.A(net238),
    .X(net237));
 sky130_fd_sc_hd__buf_6 fanout238 (.A(\core.dsp_valid_out ),
    .X(net238));
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer1 (.A(_0303_),
    .X(net256));
 sky130_fd_sc_hd__clkbuf_2 rebuffer2 (.A(_2868_),
    .X(net257));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer3 (.A(_0297_),
    .X(net258));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer4 (.A(_0204_),
    .X(net259));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer5 (.A(_0300_),
    .X(net260));
 sky130_fd_sc_hd__buf_6 rebuffer6 (.A(_0205_),
    .X(net261));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer7 (.A(_0292_),
    .X(net262));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer8 (.A(_3029_),
    .X(net263));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer9 (.A(_0304_),
    .X(net264));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer10 (.A(_0404_),
    .X(net265));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer11 (.A(_0517_),
    .X(net266));
 sky130_fd_sc_hd__clkbuf_2 rebuffer12 (.A(_2514_),
    .X(net267));
 sky130_fd_sc_hd__buf_1 rebuffer13 (.A(_0401_),
    .X(net268));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer14 (.A(_1808_),
    .X(net269));
 sky130_fd_sc_hd__clkbuf_2 rebuffer15 (.A(_2875_),
    .X(net270));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer16 (.A(_0258_),
    .X(net271));
 sky130_fd_sc_hd__buf_2 rebuffer17 (.A(_0155_),
    .X(net272));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer18 (.A(_0299_),
    .X(net273));
 sky130_fd_sc_hd__clkbuf_2 rebuffer19 (.A(_2512_),
    .X(net274));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer20 (.A(_1807_),
    .X(net275));
 sky130_fd_sc_hd__buf_6 rebuffer21 (.A(net357),
    .X(net276));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer22 (.A(_2238_),
    .X(net277));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer23 (.A(_1985_),
    .X(net278));
 sky130_fd_sc_hd__clkbuf_1 clone24 (.A(\core.u_regfile.registers[2][3] ),
    .X(net279));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer25 (.A(_0145_),
    .X(net280));
 sky130_fd_sc_hd__clkbuf_1 clone26 (.A(net89),
    .X(net281));
 sky130_fd_sc_hd__clkbuf_1 clone27 (.A(net220),
    .X(net282));
 sky130_fd_sc_hd__clkbuf_1 clone28 (.A(net219),
    .X(net283));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer33 (.A(_2756_),
    .X(net288));
 sky130_fd_sc_hd__buf_1 rebuffer34 (.A(_0529_),
    .X(net289));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer40 (.A(_2873_),
    .X(net295));
 sky130_fd_sc_hd__buf_1 rebuffer41 (.A(_1828_),
    .X(net296));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer45 (.A(_0528_),
    .X(net300));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer46 (.A(_2771_),
    .X(net301));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer47 (.A(_2720_),
    .X(net302));
 sky130_fd_sc_hd__clkbuf_2 rebuffer58 (.A(_2596_),
    .X(net313));
 sky130_fd_sc_hd__clkbuf_2 rebuffer59 (.A(_2595_),
    .X(net314));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer60 (.A(_2438_),
    .X(net315));
 sky130_fd_sc_hd__buf_2 rebuffer61 (.A(_2326_),
    .X(net316));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer62 (.A(_2518_),
    .X(net317));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer63 (.A(_2544_),
    .X(net318));
 sky130_fd_sc_hd__clkbuf_2 rebuffer64 (.A(_2522_),
    .X(net319));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer65 (.A(_2520_),
    .X(net320));
 sky130_fd_sc_hd__clkbuf_1 clone66 (.A(net214),
    .X(net321));
 sky130_fd_sc_hd__clkbuf_2 rebuffer67 (.A(net323),
    .X(net322));
 sky130_fd_sc_hd__clkbuf_2 rebuffer68 (.A(net324),
    .X(net323));
 sky130_fd_sc_hd__clkbuf_2 rebuffer69 (.A(net325),
    .X(net324));
 sky130_fd_sc_hd__clkbuf_2 rebuffer70 (.A(net326),
    .X(net325));
 sky130_fd_sc_hd__clkbuf_2 rebuffer71 (.A(net327),
    .X(net326));
 sky130_fd_sc_hd__clkbuf_2 rebuffer72 (.A(net328),
    .X(net327));
 sky130_fd_sc_hd__clkbuf_2 rebuffer73 (.A(net329),
    .X(net328));
 sky130_fd_sc_hd__clkbuf_2 rebuffer74 (.A(net330),
    .X(net329));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer75 (.A(net331),
    .X(net330));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer76 (.A(net332),
    .X(net331));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer77 (.A(net333),
    .X(net332));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer78 (.A(net334),
    .X(net333));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer79 (.A(net335),
    .X(net334));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer80 (.A(net358),
    .X(net335));
 sky130_fd_sc_hd__buf_6 rebuffer81 (.A(_2151_),
    .X(net336));
 sky130_fd_sc_hd__clkbuf_2 rebuffer84 (.A(_2592_),
    .X(net339));
 sky130_fd_sc_hd__buf_6 rebuffer85 (.A(net339),
    .X(net340));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer86 (.A(_2590_),
    .X(net341));
 sky130_fd_sc_hd__clkbuf_2 rebuffer102 (.A(_2511_),
    .X(net357));
 sky130_fd_sc_hd__buf_2 rebuffer103 (.A(_2545_),
    .X(net358));
 sky130_fd_sc_hd__clkbuf_1 clone104 (.A(net209),
    .X(net359));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer122 (.A(_2702_),
    .X(net377));
 sky130_fd_sc_hd__buf_6 rebuffer123 (.A(_2756_),
    .X(net378));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer124 (.A(_2786_),
    .X(net379));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer128 (.A(_2509_),
    .X(net383));
 sky130_fd_sc_hd__buf_4 rebuffer129 (.A(_2608_),
    .X(net384));
 sky130_fd_sc_hd__dlygate4sd3_1 hold130 (.A(\core.u_regfile.registers[1][20] ),
    .X(net385));
 sky130_fd_sc_hd__dlygate4sd3_1 hold131 (.A(\core.u_regfile.registers[1][31] ),
    .X(net386));
 sky130_fd_sc_hd__dlygate4sd3_1 hold132 (.A(\core.u_regfile.registers[2][31] ),
    .X(net387));
 sky130_fd_sc_hd__dlygate4sd3_1 hold133 (.A(\core.inst_addr_out[31] ),
    .X(net388));
 sky130_fd_sc_hd__dlygate4sd3_1 hold134 (.A(\core.inst_addr_out[27] ),
    .X(net389));
 sky130_fd_sc_hd__dlygate4sd3_1 hold135 (.A(\core.inst_addr_out[15] ),
    .X(net390));
 sky130_fd_sc_hd__dlygate4sd3_1 hold136 (.A(\core.inst_addr_out[19] ),
    .X(net391));
 sky130_fd_sc_hd__dlygate4sd3_1 hold137 (.A(\core.inst_addr_out[22] ),
    .X(net392));
 sky130_fd_sc_hd__dlygate4sd3_1 hold138 (.A(\core.inst_addr_out[18] ),
    .X(net393));
 sky130_fd_sc_hd__dlygate4sd3_1 hold139 (.A(\core.inst_addr_out[9] ),
    .X(net394));
 sky130_fd_sc_hd__dlygate4sd3_1 hold140 (.A(\core.inst_addr_out[6] ),
    .X(net395));
 sky130_fd_sc_hd__dlygate4sd3_1 hold141 (.A(\core.inst_addr_out[10] ),
    .X(net396));
 sky130_fd_sc_hd__dlygate4sd3_1 hold142 (.A(\core.inst_addr_out[2] ),
    .X(net397));
 sky130_fd_sc_hd__dlygate4sd3_1 hold143 (.A(\core.inst_addr_out[4] ),
    .X(net398));
 sky130_fd_sc_hd__dlygate4sd3_1 hold144 (.A(\core.inst_addr_out[7] ),
    .X(net399));
 sky130_fd_sc_hd__dlygate4sd3_1 hold145 (.A(\core.inst_addr_out[16] ),
    .X(net400));
 sky130_fd_sc_hd__dlygate4sd3_1 hold146 (.A(\core.inst_addr_out[24] ),
    .X(net401));
 sky130_fd_sc_hd__dlygate4sd3_1 hold147 (.A(\core.inst_addr_out[12] ),
    .X(net402));
 sky130_fd_sc_hd__dlygate4sd3_1 hold148 (.A(\core.u_regfile.registers[1][30] ),
    .X(net403));
 sky130_fd_sc_hd__dlygate4sd3_1 hold149 (.A(\core.inst_addr_out[21] ),
    .X(net404));
 sky130_fd_sc_hd__dlygate4sd3_1 hold150 (.A(\core.inst_addr_out[23] ),
    .X(net405));
 sky130_fd_sc_hd__dlygate4sd3_1 hold151 (.A(\core.inst_addr_out[13] ),
    .X(net406));
 sky130_fd_sc_hd__dlygate4sd3_1 hold152 (.A(\core.inst_addr_out[29] ),
    .X(net407));
 sky130_fd_sc_hd__dlygate4sd3_1 hold153 (.A(\core.inst_addr_out[11] ),
    .X(net408));
 sky130_fd_sc_hd__dlygate4sd3_1 hold154 (.A(\core.inst_addr_out[8] ),
    .X(net409));
 sky130_fd_sc_hd__dlygate4sd3_1 hold155 (.A(\core.inst_addr_out[25] ),
    .X(net410));
 sky130_fd_sc_hd__dlygate4sd3_1 hold156 (.A(\core.u_regfile.registers[2][30] ),
    .X(net411));
 sky130_fd_sc_hd__dlygate4sd3_1 hold157 (.A(\core.inst_addr_out[5] ),
    .X(net412));
 sky130_fd_sc_hd__dlygate4sd3_1 hold158 (.A(\core.inst_addr_out[20] ),
    .X(net413));
 sky130_fd_sc_hd__dlygate4sd3_1 hold159 (.A(\core.inst_addr_out[17] ),
    .X(net414));
 sky130_fd_sc_hd__dlygate4sd3_1 hold160 (.A(\core.inst_addr_out[14] ),
    .X(net415));
 sky130_fd_sc_hd__dlygate4sd3_1 hold161 (.A(\core.inst_addr_out[26] ),
    .X(net416));
 sky130_fd_sc_hd__dlygate4sd3_1 hold162 (.A(\core.inst_addr_out[28] ),
    .X(net417));
 sky130_fd_sc_hd__dlygate4sd3_1 hold163 (.A(\core.u_regfile.registers[1][21] ),
    .X(net418));
 sky130_fd_sc_hd__diode_2 ANTENNA_1 (.DIODE(\core.u_regfile.registers[1][10] ));
 sky130_fd_sc_hd__diode_2 ANTENNA_2 (.DIODE(\core.u_regfile.registers[1][16] ));
 sky130_fd_sc_hd__diode_2 ANTENNA_3 (.DIODE(net34));
 sky130_fd_sc_hd__diode_2 ANTENNA_4 (.DIODE(net34));
 sky130_fd_sc_hd__diode_2 ANTENNA_5 (.DIODE(net56));
 sky130_fd_sc_hd__diode_2 ANTENNA_6 (.DIODE(net126));
 sky130_fd_sc_hd__diode_2 ANTENNA_7 (.DIODE(net142));
 sky130_fd_sc_hd__diode_2 ANTENNA_8 (.DIODE(net150));
 sky130_fd_sc_hd__diode_2 ANTENNA_9 (.DIODE(net164));
 sky130_fd_sc_hd__diode_2 ANTENNA_10 (.DIODE(net164));
 sky130_fd_sc_hd__diode_2 ANTENNA_11 (.DIODE(net189));
 sky130_fd_sc_hd__diode_2 ANTENNA_12 (.DIODE(net198));
 sky130_fd_sc_hd__diode_2 ANTENNA_13 (.DIODE(net201));
 sky130_fd_sc_hd__diode_2 ANTENNA_14 (.DIODE(net202));
 sky130_fd_sc_hd__diode_2 ANTENNA_15 (.DIODE(net279));
 ...
 sky130_fd_sc_hd__decap_6 FILLER_1_346 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_1_466 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_1_629 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_2_385 ();
 sky130_fd_sc_hd__fill_1 FILLER_2_391 ();
 sky130_ef_sc_hd__decap_12 FILLER_2_399 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_2_602 ();
 sky130_ef_sc_hd__decap_12 FILLER_2_614 ();
 sky130_fd_sc_hd__decap_8 FILLER_2_626 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_3_434 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_3_535 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_4_603 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_6_545 ();
 sky130_fd_sc_hd__decap_8 FILLER_6_567 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_7_442 ();
 sky130_fd_sc_hd__fill_1 FILLER_7_447 ();
 sky130_ef_sc_hd__decap_12 FILLER_7_449 ();
 sky130_ef_sc_hd__decap_12 FILLER_7_461 ();
 sky130_ef_sc_hd__decap_12 FILLER_7_473 ();
 sky130_fd_sc_hd__decap_8 FILLER_7_488 ();
 sky130_fd_sc_hd__fill_1 FILLER_7_496 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_8_515 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_9_462 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_9_630 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_10_384 ();
 sky130_fd_sc_hd__fill_2 FILLER_10_392 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_10_515 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_11_574 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_12_104 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_12_386 ();
 sky130_fd_sc_hd__fill_2 FILLER_12_394 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_13_246 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_14_606 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_15_63 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_15_490 ();
 sky130_fd_sc_hd__fill_2 FILLER_15_502 ();
 sky130_ef_sc_hd__decap_12 FILLER_15_535 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_15_583 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_16_516 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_17_525 ();
 sky130_ef_sc_hd__decap_12 FILLER_17_533 ();
 sky130_fd_sc_hd__decap_8 FILLER_17_545 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_18_207 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_18_452 ();
 sky130_fd_sc_hd__decap_8 FILLER_18_466 ();
 sky130_fd_sc_hd__fill_2 FILLER_18_474 ();
 sky130_ef_sc_hd__decap_12 FILLER_18_490 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_18_577 ();
 sky130_fd_sc_hd__decap_3 FILLER_18_585 ();
 sky130_fd_sc_hd__fill_1 FILLER_18_589 ();
 sky130_fd_sc_hd__decap_6 FILLER_18_603 ();
 sky130_fd_sc_hd__decap_4 FILLER_18_632 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_19_407 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_19_540 ();
 sky130_fd_sc_hd__decap_8 FILLER_19_552 ();
 sky130_ef_sc_hd__decap_12 FILLER_19_565 ();
 sky130_fd_sc_hd__decap_6 FILLER_19_577 ();
 sky130_fd_sc_hd__fill_1 FILLER_19_583 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_20_440 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_20_509 ();
 sky130_ef_sc_hd__decap_12 FILLER_20_533 ();
 sky130_ef_sc_hd__decap_12 FILLER_20_545 ();
 sky130_fd_sc_hd__decap_3 FILLER_20_557 ();
 sky130_ef_sc_hd__decap_12 FILLER_20_569 ();
 sky130_fd_sc_hd__decap_4 FILLER_20_581 ();
 sky130_fd_sc_hd__decap_6 FILLER_20_609 ();
 sky130_fd_sc_hd__decap_8 FILLER_20_618 ();
 sky130_fd_sc_hd__fill_2 FILLER_20_626 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_21_592 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_22_487 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_23_597 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_24_357 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_24_626 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_25_342 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_25_430 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_25_540 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_26_619 ();
 sky130_fd_sc_hd__fill_1 FILLER_26_627 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_27_318 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_28_437 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_28_571 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_29_95 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_29_434 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_29_524 ();
 sky130_ef_sc_hd__decap_12 FILLER_29_538 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_30_636 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_31_539 ();
 sky130_fd_sc_hd__fill_2 FILLER_31_551 ();
 sky130_ef_sc_hd__decap_12 FILLER_31_569 ();
 sky130_ef_sc_hd__decap_12 FILLER_31_581 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_32_293 ();
 sky130_fd_sc_hd__decap_6 FILLER_32_301 ();
 sky130_fd_sc_hd__fill_1 FILLER_32_307 ();
 sky130_ef_sc_hd__decap_12 FILLER_32_309 ();
 sky130_fd_sc_hd__decap_3 FILLER_32_321 ();
 sky130_fd_sc_hd__decap_8 FILLER_32_330 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_32_564 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_33_487 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_33_567 ();
 sky130_ef_sc_hd__decap_12 FILLER_33_579 ();
 sky130_fd_sc_hd__decap_8 FILLER_33_594 ();
 sky130_fd_sc_hd__decap_3 FILLER_33_602 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_34_397 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_34_490 ();
 sky130_ef_sc_hd__decap_12 FILLER_34_502 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_34_628 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_35_288 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_35_529 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_37_64 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_37_175 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_37_424 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_37_477 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_37_626 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_38_213 ();
 sky130_fd_sc_hd__decap_6 FILLER_38_225 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_38_441 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_38_499 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_38_592 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_39_94 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_39_424 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_41_291 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_42_318 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_42_413 ();
 sky130_ef_sc_hd__decap_12 FILLER_42_438 ();
 sky130_fd_sc_hd__decap_6 FILLER_42_450 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_43_406 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_43_512 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_44_44 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_44_122 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_44_336 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_44_597 ();
 sky130_fd_sc_hd__decap_4 FILLER_44_632 ();
 sky130_fd_sc_hd__fill_1 FILLER_44_636 ();
 sky130_ef_sc_hd__decap_12 FILLER_45_3 ();
 sky130_fd_sc_hd__decap_8 FILLER_45_15 ();
 sky130_fd_sc_hd__decap_4 FILLER_45_28 ();
 sky130_fd_sc_hd__decap_8 FILLER_45_41 ();
 sky130_fd_sc_hd__fill_1 FILLER_45_55 ();
 sky130_fd_sc_hd__decap_3 FILLER_45_74 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_45_362 ();
 sky130_fd_sc_hd__decap_6 FILLER_45_386 ();
 sky130_ef_sc_hd__decap_12 FILLER_45_410 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_45_472 ();
 sky130_fd_sc_hd__fill_1 FILLER_45_486 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_45_567 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_46_182 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_46_601 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_47_609 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_48_484 ();
 sky130_fd_sc_hd__decap_8 FILLER_48_496 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_49_24 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_49_594 ();
 sky130_fd_sc_hd__decap_8 FILLER_49_606 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_50_124 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_50_240 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_50_382 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_51_172 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_51_242 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_51_518 ();
 sky130_fd_sc_hd__decap_3 FILLER_51_526 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_52_58 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_52_177 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_52_334 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_52_449 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_53_622 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_54_331 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_54_565 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_55_407 ();
 sky130_ef_sc_hd__decap_12 FILLER_55_419 ();
 sky130_fd_sc_hd__fill_2 FILLER_55_440 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_55_530 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_56_350 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_56_491 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_57_38 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_57_122 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_57_407 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_57_537 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_58_44 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_58_172 ();
 sky130_ef_sc_hd__decap_12 FILLER_58_184 ();
 sky130_fd_sc_hd__fill_2 FILLER_58_197 ();
 sky130_fd_sc_hd__decap_8 FILLER_58_207 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_58_260 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_58_521 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_58_626 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_59_72 ();
 sky130_ef_sc_hd__decap_12 FILLER_59_84 ();
 sky130_fd_sc_hd__fill_1 FILLER_59_96 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_59_419 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_59_592 ();
 sky130_fd_sc_hd__fill_1 FILLER_59_615 ();
 sky130_fd_sc_hd__fill_2 FILLER_59_617 ();
 sky130_fd_sc_hd__decap_6 FILLER_59_622 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_60_427 ();
 sky130_fd_sc_hd__fill_1 FILLER_60_433 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_60_561 ();
 sky130_ef_sc_hd__decap_12 FILLER_60_573 ();
 sky130_fd_sc_hd__decap_3 FILLER_60_585 ();
 sky130_ef_sc_hd__decap_12 FILLER_60_616 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_61_352 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_61_422 ();
 sky130_fd_sc_hd__decap_4 FILLER_61_434 ();
 sky130_fd_sc_hd__fill_1 FILLER_61_438 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_61_574 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_62_506 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_63_122 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_63_416 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_63_474 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_63_527 ();
 sky130_ef_sc_hd__decap_12 FILLER_63_548 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_64_55 ();
 sky130_fd_sc_hd__decap_6 FILLER_64_60 ();
 sky130_fd_sc_hd__fill_1 FILLER_64_66 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_64_402 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_64_543 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_65_24 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_65_271 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_65_587 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_66_50 ();
 sky130_fd_sc_hd__decap_4 FILLER_66_62 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_66_274 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_66_440 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_66_612 ();
 sky130_fd_sc_hd__decap_3 FILLER_66_622 ();
 sky130_ef_sc_hd__decap_12 FILLER_67_3 ();
 sky130_fd_sc_hd__decap_3 FILLER_67_15 ();
 sky130_fd_sc_hd__decap_8 FILLER_67_23 ();
 sky130_fd_sc_hd__fill_2 FILLER_67_31 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_67_153 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_67_284 ();
 sky130_ef_sc_hd__decap_12 FILLER_67_296 ();
 sky130_ef_sc_hd__decap_12 FILLER_67_308 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_67_464 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_67_594 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_68_61 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_69_380 ();
 sky130_fd_sc_hd__fill_1 FILLER_69_386 ();
 sky130_fd_sc_hd__decap_6 FILLER_69_397 ();
 sky130_ef_sc_hd__decap_12 FILLER_69_408 ();
 sky130_ef_sc_hd__decap_12 FILLER_69_420 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_69_623 ();
 sky130_fd_sc_hd__fill_2 FILLER_69_635 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_70_232 ();
 sky130_fd_sc_hd__fill_1 FILLER_70_251 ();
 sky130_fd_sc_hd__decap_4 FILLER_70_260 ();
 sky130_fd_sc_hd__fill_1 FILLER_70_264 ();
 sky130_ef_sc_hd__decap_12 FILLER_70_270 ();
 sky130_ef_sc_hd__decap_12 FILLER_70_282 ();
 sky130_ef_sc_hd__decap_12 FILLER_70_294 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_71_30 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_71_192 ();
 sky130_ef_sc_hd__decap_12 FILLER_71_204 ();
 sky130_fd_sc_hd__fill_2 FILLER_71_216 ();
 sky130_fd_sc_hd__fill_2 FILLER_71_222 ();
 sky130_fd_sc_hd__decap_8 FILLER_71_228 ();
 sky130_fd_sc_hd__decap_3 FILLER_71_236 ();
 sky130_ef_sc_hd__decap_12 FILLER_71_245 ();
 sky130_fd_sc_hd__decap_8 FILLER_71_257 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_71_368 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_71_464 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_71_521 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_71_575 ();
 sky130_fd_sc_hd__fill_1 FILLER_71_583 ();
 sky130_fd_sc_hd__fill_1 FILLER_71_612 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_72_37 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_72_173 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_72_356 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_72_447 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_72_526 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_73_77 ();
 sky130_ef_sc_hd__decap_12 FILLER_73_89 ();
 sky130_fd_sc_hd__decap_8 FILLER_73_101 ();
 sky130_fd_sc_hd__decap_3 FILLER_73_109 ();
 sky130_ef_sc_hd__decap_12 FILLER_73_116 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_73_352 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_73_468 ();
 sky130_ef_sc_hd__decap_12 FILLER_73_477 ();
 sky130_fd_sc_hd__decap_6 FILLER_73_489 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_74_36 ();
 sky130_ef_sc_hd__decap_12 FILLER_74_49 ();
 sky130_ef_sc_hd__decap_12 FILLER_74_61 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_74_324 ();
 sky130_fd_sc_hd__decap_3 FILLER_74_332 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_74_407 ();
 sky130_fd_sc_hd__fill_1 FILLER_74_413 ();
 sky130_ef_sc_hd__decap_12 FILLER_74_428 ();
 sky130_ef_sc_hd__decap_12 FILLER_74_440 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_74_540 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_75_80 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_75_245 ();
 sky130_ef_sc_hd__decap_12 FILLER_75_261 ();
 sky130_ef_sc_hd__decap_12 FILLER_75_286 ();
 sky130_ef_sc_hd__decap_12 FILLER_75_298 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_75_416 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_75_543 ();
 sky130_fd_sc_hd__decap_4 FILLER_75_556 ();
 sky130_ef_sc_hd__decap_12 FILLER_75_566 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_76_59 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_76_170 ();
 sky130_fd_sc_hd__fill_1 FILLER_76_176 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_76_503 ();
 sky130_ef_sc_hd__decap_12 FILLER_76_515 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_76_626 ();
 sky130_fd_sc_hd__decap_3 FILLER_76_634 ();
 sky130_ef_sc_hd__decap_12 FILLER_77_3 ();
 sky130_fd_sc_hd__decap_8 FILLER_77_15 ();
 sky130_fd_sc_hd__fill_2 FILLER_77_23 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_77_245 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_77_547 ();
 sky130_fd_sc_hd__decap_8 FILLER_77_571 ();
 sky130_fd_sc_hd__fill_1 FILLER_77_579 ();
 sky130_ef_sc_hd__decap_12 FILLER_77_586 ();
 sky130_fd_sc_hd__decap_8 FILLER_77_598 ();
 sky130_fd_sc_hd__decap_3 FILLER_77_606 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_78_64 ();
 sky130_fd_sc_hd__decap_8 FILLER_78_76 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_78_180 ();
 sky130_fd_sc_hd__fill_1 FILLER_78_192 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_78_426 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_79_251 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_79_348 ();
 sky130_ef_sc_hd__decap_12 FILLER_79_362 ();
 sky130_fd_sc_hd__decap_8 FILLER_79_374 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_80_268 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_80_324 ();
 sky130_fd_sc_hd__decap_6 FILLER_80_336 ();
 sky130_fd_sc_hd__fill_1 FILLER_80_342 ();
 sky130_ef_sc_hd__decap_12 FILLER_80_349 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_80_536 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_80_631 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_81_137 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_82_49 ();
 sky130_fd_sc_hd__decap_6 FILLER_82_61 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_82_260 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_82_317 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_82_457 ();
 sky130_fd_sc_hd__fill_2 FILLER_82_465 ();
 sky130_fd_sc_hd__fill_1 FILLER_82_472 ();
 sky130_fd_sc_hd__fill_1 FILLER_82_482 ();
 sky130_ef_sc_hd__decap_12 FILLER_82_490 ();
 sky130_ef_sc_hd__decap_12 FILLER_82_502 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_83_35 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_83_198 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_83_340 ();
 sky130_ef_sc_hd__decap_12 FILLER_83_352 ();
 sky130_ef_sc_hd__decap_12 FILLER_83_364 ();
 sky130_ef_sc_hd__decap_12 FILLER_83_376 ();
 sky130_fd_sc_hd__decap_4 FILLER_83_388 ();
 sky130_ef_sc_hd__decap_12 FILLER_83_407 ();
 sky130_ef_sc_hd__decap_12 FILLER_83_419 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_83_591 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_84_50 ();
 sky130_fd_sc_hd__decap_8 FILLER_84_62 ();
 sky130_fd_sc_hd__fill_1 FILLER_84_70 ();
 sky130_fd_sc_hd__decap_4 FILLER_84_79 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_84_388 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_85_65 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_85_212 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_85_353 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_85_459 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_85_521 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_85_593 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_86_165 ();
 sky130_fd_sc_hd__decap_6 FILLER_86_189 ();
 sky130_fd_sc_hd__fill_1 FILLER_86_195 ();
 sky130_fd_sc_hd__decap_4 FILLER_86_197 ();
 sky130_fd_sc_hd__decap_6 FILLER_86_210 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_86_381 ();
 sky130_ef_sc_hd__decap_12 FILLER_86_392 ();
 sky130_fd_sc_hd__decap_4 FILLER_86_404 ();
 sky130_fd_sc_hd__fill_1 FILLER_86_408 ();
 sky130_fd_sc_hd__fill_2 FILLER_86_418 ();
 sky130_ef_sc_hd__decap_12 FILLER_86_428 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_86_563 ();
 sky130_fd_sc_hd__decap_6 FILLER_86_569 ();
 sky130_fd_sc_hd__fill_2 FILLER_86_602 ();
 sky130_ef_sc_hd__decap_12 FILLER_86_607 ();
 sky130_fd_sc_hd__fill_2 FILLER_86_626 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_87_78 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_87_184 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_87_253 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_87_518 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_87_620 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_88_162 ();
 sky130_fd_sc_hd__fill_2 FILLER_88_168 ();
 sky130_ef_sc_hd__decap_12 FILLER_88_174 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_88_354 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_88_627 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_89_123 ();
 sky130_ef_sc_hd__decap_12 FILLER_89_135 ();
 sky130_fd_sc_hd__decap_6 FILLER_89_147 ();
 sky130_fd_sc_hd__decap_3 FILLER_89_169 ();
 sky130_fd_sc_hd__fill_1 FILLER_89_177 ();
 sky130_fd_sc_hd__decap_6 FILLER_89_185 ();
 sky130_fd_sc_hd__fill_1 FILLER_89_191 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_89_316 ();
 sky130_fd_sc_hd__decap_6 FILLER_89_341 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_89_509 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_89_573 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_90_70 ();
 sky130_fd_sc_hd__fill_1 FILLER_90_83 ();
 sky130_ef_sc_hd__decap_12 FILLER_90_85 ();
 sky130_ef_sc_hd__decap_12 FILLER_90_97 ();
 sky130_fd_sc_hd__decap_3 FILLER_90_109 ();
 sky130_fd_sc_hd__decap_4 FILLER_90_129 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_90_182 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_90_611 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_91_64 ();
 sky130_ef_sc_hd__decap_12 FILLER_91_80 ();
 sky130_fd_sc_hd__decap_6 FILLER_91_92 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_91_396 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_91_574 ();
 sky130_fd_sc_hd__decap_3 FILLER_91_586 ();
 sky130_fd_sc_hd__decap_8 FILLER_91_602 ();
 sky130_fd_sc_hd__fill_1 FILLER_91_610 ();
 sky130_fd_sc_hd__fill_2 FILLER_91_617 ();
 sky130_fd_sc_hd__fill_2 FILLER_91_626 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_92_101 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_92_159 ();
 sky130_ef_sc_hd__decap_12 FILLER_92_171 ();
 sky130_ef_sc_hd__decap_12 FILLER_92_183 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_92_266 ();
 sky130_ef_sc_hd__decap_12 FILLER_92_278 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_92_377 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_92_547 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_93_125 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_93_400 ();
 sky130_ef_sc_hd__decap_12 FILLER_93_412 ();
 sky130_ef_sc_hd__decap_12 FILLER_93_424 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_94_214 ();
 sky130_fd_sc_hd__decap_6 FILLER_94_221 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_94_425 ();
 sky130_ef_sc_hd__decap_12 FILLER_94_437 ();
 sky130_fd_sc_hd__decap_6 FILLER_94_449 ();
 sky130_fd_sc_hd__fill_1 FILLER_94_455 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_94_629 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_96_133 ();
 sky130_fd_sc_hd__decap_3 FILLER_96_137 ();
 sky130_fd_sc_hd__decap_6 FILLER_96_149 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_96_330 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_96_435 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_97_302 ();
 sky130_ef_sc_hd__decap_12 FILLER_97_319 ();
 sky130_fd_sc_hd__decap_4 FILLER_97_331 ();
 sky130_fd_sc_hd__fill_1 FILLER_97_335 ();
 sky130_ef_sc_hd__decap_12 FILLER_97_350 ();
 sky130_ef_sc_hd__decap_12 FILLER_97_362 ();
 sky130_fd_sc_hd__decap_6 FILLER_97_374 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_97_495 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_97_549 ();
 sky130_fd_sc_hd__fill_1 FILLER_97_559 ();
 sky130_fd_sc_hd__fill_1 FILLER_97_572 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_98_121 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_98_281 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_98_400 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_98_489 ();
 sky130_ef_sc_hd__decap_12 FILLER_98_512 ();
 sky130_fd_sc_hd__decap_8 FILLER_98_524 ();
 sky130_fd_sc_hd__decap_8 FILLER_98_533 ();
 sky130_fd_sc_hd__fill_2 FILLER_98_541 ();
 sky130_fd_sc_hd__decap_8 FILLER_98_556 ();
 sky130_fd_sc_hd__decap_3 FILLER_98_564 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_99_201 ();
 sky130_ef_sc_hd__decap_12 FILLER_99_205 ();
 sky130_fd_sc_hd__decap_6 FILLER_99_217 ();
 sky130_fd_sc_hd__fill_1 FILLER_99_223 ();
 sky130_fd_sc_hd__fill_2 FILLER_99_239 ();
 sky130_fd_sc_hd__decap_8 FILLER_99_248 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_99_320 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_99_588 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_100_213 ();
 sky130_fd_sc_hd__decap_6 FILLER_100_225 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_100_279 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_100_613 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_101_297 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_101_404 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_101_483 ();
 sky130_fd_sc_hd__decap_8 FILLER_101_495 ();
 sky130_fd_sc_hd__fill_1 FILLER_101_503 ();
 sky130_ef_sc_hd__decap_12 FILLER_101_505 ();
 sky130_ef_sc_hd__decap_12 FILLER_101_517 ();
 sky130_ef_sc_hd__decap_12 FILLER_101_536 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_102_289 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_102_541 ();
 sky130_ef_sc_hd__decap_12 FILLER_102_553 ();
 sky130_fd_sc_hd__decap_8 FILLER_102_565 ();
 sky130_fd_sc_hd__fill_2 FILLER_102_573 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_103_212 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_103_298 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_103_342 ();
 sky130_fd_sc_hd__fill_2 FILLER_103_369 ();
 sky130_fd_sc_hd__decap_3 FILLER_103_389 ();
 sky130_fd_sc_hd__fill_2 FILLER_103_398 ();
 sky130_fd_sc_hd__fill_1 FILLER_103_408 ();
 sky130_fd_sc_hd__fill_2 FILLER_103_423 ();
 sky130_fd_sc_hd__fill_2 FILLER_103_430 ();
 sky130_fd_sc_hd__decap_3 FILLER_103_437 ();
 sky130_fd_sc_hd__fill_2 FILLER_103_457 ();
 sky130_fd_sc_hd__decap_3 FILLER_103_479 ();
 sky130_fd_sc_hd__decap_8 FILLER_103_485 ();
 sky130_fd_sc_hd__fill_2 FILLER_103_493 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_104_177 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_104_221 ();
 sky130_fd_sc_hd__decap_6 FILLER_104_234 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_104_284 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_104_393 ();
 sky130_fd_sc_hd__fill_1 FILLER_104_412 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_104_505 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_105_305 ();
 sky130_fd_sc_hd__decap_6 FILLER_105_310 ();
 sky130_fd_sc_hd__decap_3 FILLER_105_322 ();
 sky130_ef_sc_hd__decap_12 FILLER_105_341 ();
 sky130_ef_sc_hd__decap_12 FILLER_105_356 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_105_413 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_105_457 ();
 sky130_fd_sc_hd__decap_4 FILLER_105_467 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_106_433 ();
 sky130_ef_sc_hd__decap_12 FILLER_106_446 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_106_506 ();
 sky130_ef_sc_hd__decap_12 FILLER_106_518 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_106_609 ();
 sky130_ef_sc_hd__decap_12 FILLER_106_621 ();
 sky130_fd_sc_hd__decap_4 FILLER_106_633 ();
 sky130_ef_sc_hd__decap_12 FILLER_107_3 ();
 sky130_ef_sc_hd__decap_12 FILLER_107_15 ();
 sky130_fd_sc_hd__fill_1 FILLER_107_27 ();
 sky130_ef_sc_hd__decap_12 FILLER_107_29 ();
 sky130_ef_sc_hd__decap_12 FILLER_107_41 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_107_421 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_107_523 ();
 sky130_fd_sc_hd__fill_1 FILLER_107_531 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_107_573 ();
 sky130_fd_sc_hd__fill_2 FILLER_107_581 ();
 sky130_fd_sc_hd__fill_1 FILLER_107_587 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_107_629 ();
endmodule
