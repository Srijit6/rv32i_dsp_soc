module soc_top (clk,
 ...
 sky130_fd_sc_hd__inv_2 _3062_ (.A(net352),
 ...
 sky130_fd_sc_hd__and2_4 _3065_ (.A(net206),
    .B(net198),
    .X(_1932_));
 sky130_fd_sc_hd__and3_1 _3066_ (.A(net322),
    .B(net175),
    .C(net298),
    .X(_1943_));
 sky130_fd_sc_hd__and2_1 _3067_ (.A(net208),
    .B(net203),
    .X(_1954_));
 sky130_fd_sc_hd__and3_1 _3068_ (.A(net322),
    .B(net204),
    .C(net167),
    .X(_1965_));
 ...
 sky130_fd_sc_hd__o21ai_1 _3076_ (.A1(_2030_),
    ...
    .B1(_1998_),
    .Y(_2052_));
 sky130_fd_sc_hd__nand2_2 _3077_ (.A(net172),
    .B(net104),
    .Y(_2063_));
 ...
 sky130_fd_sc_hd__and3_4 _3082_ (.A(net215),
    ...
    .C(net197),
    .X(_2118_));
 sky130_fd_sc_hd__and3_1 _3083_ (.A(net300),
    .B(net174),
 ...
 sky130_fd_sc_hd__and2_1 _3088_ (.A(net235),
    .B(net171),
    .X(_2184_));
 sky130_fd_sc_hd__and3_1 _3089_ (.A(net322),
    .B(net199),
    .C(net169),
    .X(_2194_));
 ...
 sky130_fd_sc_hd__xor2_2 _3102_ (.A(_2314_),
    .B(_2238_),
    .X(_2326_));
 sky130_fd_sc_hd__xor2_1 _3103_ (.A(_2326_),
    .B(_2227_),
    .X(_2332_));
 ...
 sky130_fd_sc_hd__nand4_1 _3111_ (.A(net165),
    ...
    .D(net76),
    .Y(_2382_));
 sky130_fd_sc_hd__nand2_4 _3112_ (.A(net165),
    .B(net88),
    .Y(_2389_));
 ...
 sky130_fd_sc_hd__xnor2_1 _3119_ (.A(_2389_),
    .B(_2410_),
    .Y(_2411_));
 sky130_fd_sc_hd__nor2_2 _3120_ (.A(_2411_),
    .B(_2382_),
    .Y(_2412_));
 ...
 sky130_fd_sc_hd__nand2_1 _3125_ (.A(_2415_),
    .B(_2416_),
    .Y(_2417_));
 sky130_fd_sc_hd__and3_1 _3126_ (.A(net296),
    .B(net205),
    .C(net167),
    .X(_2418_));
 sky130_fd_sc_hd__and3_1 _3127_ (.A(net296),
    .B(net199),
    .C(net174),
    .X(_2419_));
 sky130_fd_sc_hd__and3_1 _3128_ (.A(net296),
    .B(net205),
    .C(net174),
    .X(_2420_));
 sky130_fd_sc_hd__nand2_1 _3129_ (.A(_2260_),
    .B(_2420_),
    .Y(_2421_));
 sky130_fd_sc_hd__nand2_2 _3130_ (.A(net172),
    .B(net88),
    .Y(_2422_));
 sky130_fd_sc_hd__xnor2_2 _3131_ (.A(_2418_),
    .B(_2419_),
    .Y(_2423_));
 sky130_fd_sc_hd__or2_4 _3132_ (.A(_2422_),
    .B(_2423_),
    .X(_2424_));
 ...
 sky130_fd_sc_hd__a21o_1 _3134_ (.A1(_2421_),
    ...
    .B1(_2425_),
    .X(_2426_));
 sky130_fd_sc_hd__and3_1 _3135_ (.A(net322),
 ...
 sky130_fd_sc_hd__nand3_2 _3136_ (.A(_2421_),
    ...
    .C(_2425_),
    .Y(_2428_));
 sky130_fd_sc_hd__nand3_1 _3137_ (.A(net282),
    .B(_2427_),
    .C(_2428_),
    .Y(_2429_));
 ...
 sky130_fd_sc_hd__and2b_1 _3146_ (.A_N(_2436_),
    .B(_2437_),
    .X(_2438_));
 sky130_fd_sc_hd__and3_1 _3147_ (.A(net300),
    .B(net204),
    .C(net172),
    .X(_2439_));
 ...
 sky130_fd_sc_hd__a21o_1 _3154_ (.A1(_2426_),
    ...
    .B1(_2427_),
    .X(_2446_));
 sky130_fd_sc_hd__and3_1 _3155_ (.A(_2446_),
    .B(_2445_),
    .C(_2429_),
    .X(_2447_));
 sky130_fd_sc_hd__a21oi_1 _3156_ (.A1(_2429_),
    ...
    .B1(_2445_),
    .Y(_2448_));
 sky130_fd_sc_hd__and4bb_1 _3157_ (.A_N(_2448_),
    .B_N(_2447_),
    .C(net165),
    .D(net76),
    .X(_2449_));
 sky130_fd_sc_hd__nand2_1 _3158_ (.A(net294),
    .B(net297),
    .Y(_2450_));
 ...
 sky130_fd_sc_hd__a31o_1 _3161_ (.A1(net169),
    ...
    .B1(_2320_),
    .X(_2453_));
 sky130_fd_sc_hd__and3_1 _3162_ (.A(net296),
    .B(net169),
    .C(net197),
    .X(_2454_));
 ...
 sky130_fd_sc_hd__and3_4 _3177_ (.A(net218),
    ...
    .C(net161),
    .X(_2469_));
 sky130_fd_sc_hd__nor2_2 _3178_ (.A(net314),
    .B(net315),
    .Y(_2470_));
 ...
 sky130_fd_sc_hd__nand2_1 _3187_ (.A(_2477_),
    .B(_2478_),
    .Y(_2479_));
 sky130_fd_sc_hd__nor2_2 _3188_ (.A(net303),
    .B(_2479_),
    .Y(_2480_));
 ...
 sky130_fd_sc_hd__nor2_1 _3190_ (.A(_2415_),
    .B(_2481_),
    .Y(_2482_));
 sky130_fd_sc_hd__xor2_1 _3191_ (.A(_2481_),
    .B(_2415_),
    .X(_2483_));
 ...
 sky130_fd_sc_hd__xor2_1 _3206_ (.A(_2432_),
    .B(_2496_),
    .X(_2498_));
 sky130_fd_sc_hd__nand2_1 _3207_ (.A(net294),
    .B(net285),
    .Y(_2499_));
 ...
 sky130_fd_sc_hd__o21ai_2 _3256_ (.A1(_2344_),
    ...
    .B1(_2492_),
    .Y(_2548_));
 sky130_fd_sc_hd__a21o_1 _3257_ (.A1(_2463_),
    .A2(_2454_),
    .B1(_2462_),
    .X(_2549_));
 sky130_fd_sc_hd__and3_1 _3258_ (.A(net295),
    .B(net169),
    .C(net195),
    .X(_2550_));
 ...
 sky130_fd_sc_hd__nand2_1 _3260_ (.A(net173),
    .B(net72),
    .Y(_2552_));
 sky130_fd_sc_hd__and2_4 _3261_ (.A(net207),
 ...
 sky130_fd_sc_hd__xnor2_4 _3270_ (.A(_2560_),
    .B(_2549_),
    .Y(_2562_));
 sky130_fd_sc_hd__o21ai_2 _3271_ (.A1(_2470_),
    .A2(_2468_),
    .B1(_2472_),
    .Y(_2563_));
 ...
 sky130_fd_sc_hd__and3_1 _3273_ (.A(net218),
    ...
    .C(net161),
    .X(_2565_));
 sky130_fd_sc_hd__and3_4 _3274_ (.A(net219),
    .B(net199),
    .C(net158),
    .X(_2566_));
 ...
 sky130_fd_sc_hd__xnor2_2 _3280_ (.A(_2571_),
    .B(_2475_),
    .Y(_2572_));
 sky130_fd_sc_hd__nor2_4 _3281_ (.A(_2477_),
    .B(net275),
    .Y(_2573_));
 ...
 sky130_fd_sc_hd__xor2_2 _3283_ (.A(_2562_),
    .B(_2574_),
    .X(_2575_));
 sky130_fd_sc_hd__and2_4 _3284_ (.A(_2480_),
    .B(net258),
    .X(_2576_));
 ...
 sky130_fd_sc_hd__and3_1 _3287_ (.A(net220),
    ...
    .C(net149),
    .X(_2579_));
 sky130_fd_sc_hd__and4_1 _3288_ (.A(net310),
    .B(\core.u_regfile.registers[1][0] ),
    .C(net204),
    .D(net149),
    .X(_2580_));
 ...
 sky130_fd_sc_hd__nand2_1 _3290_ (.A(_2578_),
    .B(_2581_),
    .Y(_2582_));
 sky130_fd_sc_hd__nor2_4 _3291_ (.A(_2582_),
    .B(net266),
    .Y(_2583_));
 ...
 sky130_fd_sc_hd__xor2_2 _3300_ (.A(_2548_),
    .B(_2590_),
    .X(_2592_));
 sky130_fd_sc_hd__xor2_2 _3301_ (.A(net265),
    .B(_2592_),
    .X(_2593_));
 ...
 sky130_fd_sc_hd__o41a_1 _3311_ (.A1(net136),
    ...
    .B1(net210),
    .X(_2603_));
 sky130_fd_sc_hd__o41a_1 _3312_ (.A1(net316),
    .A2(net160),
    .A3(net122),
    .A4(net116),
    .B1(net212),
 ...
 sky130_fd_sc_hd__o21a_1 _3320_ (.A1(_2482_),
    ...
    .B1(net256),
    .X(_2611_));
 sky130_fd_sc_hd__a21oi_4 _3321_ (.A1(net263),
    .A2(_2562_),
    .B1(_2573_),
    .Y(_2612_));
 sky130_fd_sc_hd__a21o_1 _3322_ (.A1(_2559_),
    ...
    .B1(_2558_),
    .X(_2613_));
 sky130_fd_sc_hd__and3_1 _3323_ (.A(net295),
    .B(net170),
    .C(net194),
    .X(_2614_));
 ...
 sky130_fd_sc_hd__and2_4 _3326_ (.A(net212),
    ...
    .X(_2617_));
 sky130_fd_sc_hd__and3_1 _3327_ (.A(net295),
    .B(\core.u_regfile.registers[1][9] ),
    .C(net175),
    .X(_2618_));
 sky130_fd_sc_hd__and3_1 _3328_ (.A(net300),
    .B(net167),
    .C(net195),
    .X(_2619_));
 sky130_fd_sc_hd__and3_4 _3329_ (.A(net216),
    .B(\core.u_regfile.registers[1][9] ),
    .C(net167),
    .X(_2620_));
 ...
 sky130_fd_sc_hd__a21o_1 _3338_ (.A1(_2469_),
    ...
    .B1(_2568_),
    .X(_2629_));
 sky130_fd_sc_hd__and3_1 _3339_ (.A(net310),
    .B(net166),
    .C(net197),
    .X(_2630_));
 ...
 sky130_fd_sc_hd__xnor2_2 _3349_ (.A(_2637_),
    .B(_2638_),
    .Y(_2640_));
 sky130_fd_sc_hd__nor2_1 _3350_ (.A(net273),
    .B(_2640_),
    .Y(_2641_));
 ...
 sky130_fd_sc_hd__nand2b_1 _3352_ (.A_N(_2612_),
    .B(net277),
    .Y(_2643_));
 sky130_fd_sc_hd__xnor2_2 _3353_ (.A(_2642_),
    .B(_2612_),
    .Y(_2644_));
 ...
 sky130_fd_sc_hd__xor2_2 _3361_ (.A(_2650_),
    .B(_2644_),
    .X(_2652_));
 sky130_fd_sc_hd__xnor2_4 _3362_ (.A(_2652_),
    .B(_2583_),
    .Y(_2653_));
 sky130_fd_sc_hd__xnor2_4 _3363_ (.A(_2653_),
    .B(_2576_),
    .Y(_2654_));
 ...
 sky130_fd_sc_hd__a21oi_1 _3369_ (.A1(_2514_),
    ...
    .B1(_2659_),
    .Y(_2660_));
 sky130_fd_sc_hd__o211a_1 _3370_ (.A1(_2657_),
    .A2(_2610_),
    .B1(_2548_),
    .C1(_2590_),
    .X(_2661_));
 ...
 sky130_fd_sc_hd__a311o_1 _3377_ (.A1(_2659_),
    .A2(_2592_),
    .A3(_2514_),
    .B1(_2661_),
    .C1(_2658_),
 ...
 sky130_fd_sc_hd__o21ba_1 _3379_ (.A1(_2576_),
    ...
    .B1_N(_2652_),
    .X(_2669_));
 sky130_fd_sc_hd__a31o_1 _3380_ (.A1(net269),
    .A2(net274),
    .A3(_2637_),
    .B1(_2641_),
    .X(_2670_));
 ...
 sky130_fd_sc_hd__and2_1 _3386_ (.A(net206),
    ...
    .X(_2676_));
 sky130_fd_sc_hd__and3_1 _3387_ (.A(net295),
    .B(\core.u_regfile.registers[1][10] ),
    .C(net174),
    .X(_2677_));
 sky130_fd_sc_hd__and3_1 _3388_ (.A(net295),
    .B(net167),
    .C(net194),
    .X(_2678_));
 sky130_fd_sc_hd__and3_1 _3389_ (.A(net168),
    .B(\core.u_regfile.registers[1][10] ),
    .C(net221),
    .X(_2679_));
 ...
 sky130_fd_sc_hd__nand2_1 _3393_ (.A(_2674_),
    .B(_2682_),
    .Y(_2683_));
 sky130_fd_sc_hd__xor2_2 _3394_ (.A(_2682_),
    .B(_2674_),
    .X(_2684_));
 ...
 sky130_fd_sc_hd__nand2b_1 _3396_ (.A_N(_2685_),
    .B(_2672_),
    .Y(_2686_));
 sky130_fd_sc_hd__xnor2_1 _3397_ (.A(_2685_),
    .B(_2672_),
    .Y(_2687_));
 ...
 sky130_fd_sc_hd__nand2_1 _3403_ (.A(net166),
    .B(net82),
    .Y(_2693_));
 sky130_fd_sc_hd__and3_1 _3404_ (.A(net310),
    .B(net197),
    .C(net161),
    .X(_2694_));
 sky130_fd_sc_hd__and3_1 _3405_ (.A(net310),
    .B(net198),
    .C(net158),
    .X(_2695_));
 ...
 sky130_fd_sc_hd__o21ai_1 _3448_ (.A1(_2643_),
    ...
    .B1(_2721_),
    .Y(_2737_));
 sky130_fd_sc_hd__a21o_1 _3449_ (.A1(net329),
    .A2(_2705_),
    .B1(_2706_),
    .X(_2738_));
 ...
 sky130_fd_sc_hd__and3_1 _3452_ (.A(net220),
    ...
    .C(net169),
    .X(_2741_));
 sky130_fd_sc_hd__a31o_1 _3453_ (.A1(_2681_),
    .A2(net64),
    .A3(net173),
    .B1(_2680_),
    .X(_2742_));
 ...
 sky130_fd_sc_hd__nand2_1 _3462_ (.A(_2742_),
    .B(_2750_),
    .Y(_2751_));
 sky130_fd_sc_hd__xor2_2 _3463_ (.A(_2750_),
    .B(_2742_),
    .X(_2752_));
 ...
 sky130_fd_sc_hd__nand2b_1 _3478_ (.A_N(_2765_),
    .B(_2766_),
    .Y(_2767_));
 sky130_fd_sc_hd__xor2_2 _3479_ (.A(_2766_),
    .B(_2765_),
    .X(_2768_));
 ...
 sky130_fd_sc_hd__xnor2_2 _3483_ (.A(_2703_),
    .B(_2771_),
    .Y(_2772_));
 sky130_fd_sc_hd__xor2_2 _3484_ (.A(net330),
    .B(_2772_),
    .X(_2773_));
 ...
 sky130_fd_sc_hd__xnor2_1 _3497_ (.A(_2775_),
    .B(_2784_),
    .Y(_2786_));
 sky130_fd_sc_hd__xor2_1 _3498_ (.A(_2786_),
    .B(_2719_),
    .X(_2787_));
 ...
 sky130_fd_sc_hd__inv_2 _3537_ (.A(_2824_),
    .Y(_2825_));
 sky130_fd_sc_hd__nand2_1 _3538_ (.A(net312),
    .B(net67),
    .Y(_2826_));
 ...
 sky130_fd_sc_hd__a221o_2 _3580_ (.A1(_2728_),
    ...
    .C1(_2727_),
    .X(_2868_));
 sky130_fd_sc_hd__and3_1 _3581_ (.A(_2868_),
    .B(_2867_),
    .C(_2793_),
    .X(_2869_));
 ...
 sky130_fd_sc_hd__nor2_1 _3584_ (.A(\dsp.u_mac.acc_reg[12] ),
    .B(_2871_),
    .Y(_2872_));
 sky130_fd_sc_hd__and2_4 _3585_ (.A(\dsp.u_mac.acc_reg[12] ),
    .B(_2871_),
    .X(_2873_));
 ...
 sky130_fd_sc_hd__xnor2_2 _3607_ (.A(_2881_),
    .B(_2892_),
    .Y(_2894_));
 sky130_fd_sc_hd__xor2_2 _3608_ (.A(_2894_),
    .B(_2880_),
    .X(_2895_));
 ...
 sky130_fd_sc_hd__xnor2_2 _3625_ (.A(_2836_),
    .B(_2910_),
    .Y(_2912_));
 sky130_fd_sc_hd__xor2_2 _3626_ (.A(_2912_),
    .B(_2895_),
    .X(_2913_));
 ...
 sky130_fd_sc_hd__xor2_2 _3658_ (.A(_2943_),
    .B(_2944_),
    .X(_2945_));
 sky130_fd_sc_hd__or2_4 _3659_ (.A(\dsp.u_mac.acc_reg[13] ),
    .B(_2945_),
    .X(_2946_));
 sky130_fd_sc_hd__nand2_2 _3660_ (.A(\dsp.u_mac.acc_reg[13] ),
    .B(_2945_),
    .Y(_2947_));
 sky130_fd_sc_hd__and2_4 _3661_ (.A(_2946_),
    .B(_2947_),
    .X(_2948_));
 sky130_fd_sc_hd__o21ai_4 _3662_ (.A1(_2875_),
    ...
    .B1(_2948_),
    .Y(_2949_));
 sky130_fd_sc_hd__o311a_4 _3663_ (.A1(_2873_),
    .A2(_2875_),
    .A3(_2948_),
    .B1(net34),
    .C1(_2949_),
 ...
 sky130_fd_sc_hd__a21o_1 _3667_ (.A1(_2915_),
    ...
    .B1(_2931_),
    .X(_2953_));
 sky130_fd_sc_hd__a21o_1 _3668_ (.A1(net326),
    .A2(_2912_),
    .B1(_2911_),
    .X(_2954_));
 ...
 sky130_fd_sc_hd__nand2b_1 _3855_ (.A_N(_0131_),
    .B(_0140_),
    .Y(_0141_));
 sky130_fd_sc_hd__xor2_2 _3856_ (.A(_0140_),
    .B(_0131_),
    .X(_0142_));
 sky130_fd_sc_hd__and2b_1 _3857_ (.A_N(net305),
    .B(_0130_),
    .X(_0143_));
 ...
 sky130_fd_sc_hd__nand2b_4 _3923_ (.A_N(_0208_),
    .B(_0126_),
    .Y(_0209_));
 sky130_fd_sc_hd__xnor2_1 _3924_ (.A(_0208_),
    .B(_0126_),
    .Y(_0210_));
 sky130_fd_sc_hd__and2_4 _3925_ (.A(_0125_),
    .B(_0210_),
    .X(_0211_));
 ...
 sky130_fd_sc_hd__a21o_1 _3936_ (.A1(_0166_),
    ...
    .B1(_0202_),
    .X(_0221_));
 sky130_fd_sc_hd__o21ai_2 _3937_ (.A1(net306),
    .A2(_0160_),
    .B1(_0161_),
    .Y(_0222_));
 ...
 sky130_fd_sc_hd__nand4_1 _3942_ (.A(\core.u_regfile.registers[1][14] ),
    ...
    .D(net48),
    .Y(_0227_));
 sky130_fd_sc_hd__a22o_1 _3943_ (.A1(net316),
    .A2(net52),
    .B1(_0226_),
    .B2(net178),
    .X(_0228_));
 ...
 sky130_fd_sc_hd__and3_1 _3992_ (.A(net209),
    ...
    .C(net129),
    .X(_0277_));
 sky130_fd_sc_hd__and3_1 _3993_ (.A(net300),
    .B(net200),
    .C(net126),
    .X(_0278_));
 ...
 sky130_fd_sc_hd__xnor2_2 _4004_ (.A(_0275_),
    .B(_0288_),
    .Y(_0289_));
 sky130_fd_sc_hd__xor2_4 _4005_ (.A(_0193_),
    .B(_0289_),
    .X(_0290_));
 ...
 sky130_fd_sc_hd__and2_4 _4130_ (.A(_0211_),
    .B(_0304_),
    .X(_0414_));
 sky130_fd_sc_hd__a311o_4 _4131_ (.A1(_0304_),
    .A2(_0213_),
    .A3(_0124_),
    .B1(_0306_),
    .C1(_0414_),
 ...
 sky130_fd_sc_hd__a22o_1 _4164_ (.A1(net190),
    ...
    .B2(_0446_),
    .X(_0447_));
 sky130_fd_sc_hd__nand4_1 _4165_ (.A(net313),
    .B(_3045_),
    .C(_0445_),
    .D(_0446_),
    .Y(_0448_));
 ...
 sky130_fd_sc_hd__nand2b_1 _4235_ (.A_N(_0424_),
    .B(_0517_),
    .Y(_0518_));
 sky130_fd_sc_hd__xnor2_1 _4236_ (.A(_0517_),
    .B(_0424_),
    .Y(_0519_));
 ...
 sky130_fd_sc_hd__o21a_1 _4247_ (.A1(_0528_),
    ...
    .B1(net34),
    .X(_0530_));
 sky130_fd_sc_hd__a21boi_4 _4248_ (.A1(_0528_),
    .A2(_0529_),
    .B1_N(_0530_),
 ...
 sky130_fd_sc_hd__and3_1 _4911_ (.A(net233),
    ...
    .C(net177),
    .X(_1188_));
 sky130_fd_sc_hd__a21oi_1 _4912_ (.A1(net316),
    .A2(_0774_),
    .B1(_1188_),
    .Y(_1189_));
 ...
 sky130_fd_sc_hd__and2_1 _5398_ (.A(_1654_),
    .B(_1670_),
    .X(_1672_));
 sky130_fd_sc_hd__or2_4 _5399_ (.A(_1671_),
    .B(_1672_),
    .X(_1673_));
 ...
 sky130_fd_sc_hd__and3_1 _5503_ (.A(net121),
    ...
    .C(_1776_),
    .X(_1777_));
 sky130_fd_sc_hd__or2_4 _5504_ (.A(_1775_),
    .B(_1777_),
    .X(_1778_));
 ...
 sky130_fd_sc_hd__a21oi_2 _5508_ (.A1(_1606_),
    ...
    .B1(_1780_),
    .Y(_1782_));
 sky130_fd_sc_hd__or2_4 _5509_ (.A(_1781_),
    .B(_1782_),
    .X(_1783_));
 ...
 sky130_fd_sc_hd__o21ai_2 _5706_ (.A1(_1806_),
    ...
    .B1(_1984_),
    .Y(_1986_));
 sky130_fd_sc_hd__a211o_4 _5707_ (.A1(_1986_),
    .A2(_1985_),
    .B1(_1669_),
    .C1(_1672_),
    .X(_1988_));
 ...
 sky130_fd_sc_hd__xnor2_1 _6049_ (.A(\core.inst_addr_out[13] ),
    .B(net54),
    .Y(_2340_));
 sky130_fd_sc_hd__xnor2_2 _6050_ (.A(_2340_),
    .B(\core.dsp_result_in[13] ),
    .Y(net6));
 ...
 sky130_fd_sc_hd__xnor2_1 _6053_ (.A(\core.inst_addr_out[15] ),
    .B(_3045_),
    .Y(_2342_));
 sky130_fd_sc_hd__xnor2_2 _6054_ (.A(_2342_),
    .B(\core.dsp_result_in[15] ),
    .Y(net8));
 ...
 sky130_fd_sc_hd__and2_1 _6092_ (.A(\core.inst_addr_out[5] ),
    .B(_2364_),
    .X(_2366_));
 sky130_fd_sc_hd__nor2_1 _6093_ (.A(net365),
    .B(_2364_),
    .Y(_2367_));
 sky130_fd_sc_hd__nor2_1 _6094_ (.A(_2366_),
    .B(_2367_),
    .Y(\core.u_fetch.next_pc[5] ));
 sky130_fd_sc_hd__xor2_1 _6095_ (.A(net346),
    .B(_2366_),
 ...
 sky130_fd_sc_hd__and2_1 _6099_ (.A(\core.inst_addr_out[8] ),
    .B(_2368_),
    .X(_2371_));
 sky130_fd_sc_hd__nor2_1 _6100_ (.A(net362),
    .B(_2368_),
    .Y(_2372_));
 sky130_fd_sc_hd__nor2_1 _6101_ (.A(_2371_),
    .B(_2372_),
    .Y(\core.u_fetch.next_pc[8] ));
 sky130_fd_sc_hd__xor2_1 _6102_ (.A(net345),
    .B(_2371_),
 ...
 sky130_fd_sc_hd__and2_1 _6106_ (.A(\core.inst_addr_out[11] ),
    .B(_2373_),
    .X(_2375_));
 sky130_fd_sc_hd__nor2_1 _6107_ (.A(net361),
    .B(_2373_),
    .Y(_2377_));
 sky130_fd_sc_hd__nor2_1 _6108_ (.A(_2375_),
    .B(_2377_),
    .Y(\core.u_fetch.next_pc[11] ));
 sky130_fd_sc_hd__xor2_1 _6109_ (.A(net353),
    .B(_2375_),
 ...
 sky130_fd_sc_hd__and2_1 _6113_ (.A(\core.inst_addr_out[14] ),
    .B(_2378_),
    .X(_2380_));
 sky130_fd_sc_hd__nor2_1 _6114_ (.A(net356),
    .B(_2378_),
    .Y(_2381_));
 sky130_fd_sc_hd__nor2_1 _6115_ (.A(_2380_),
    .B(_2381_),
    .Y(\core.u_fetch.next_pc[14] ));
 sky130_fd_sc_hd__xor2_1 _6116_ (.A(net341),
    .B(_2380_),
 ...
 sky130_fd_sc_hd__and2_1 _6120_ (.A(\core.inst_addr_out[17] ),
    .B(_2383_),
    .X(_2385_));
 sky130_fd_sc_hd__nor2_1 _6121_ (.A(net355),
    .B(_2383_),
    .Y(_2386_));
 sky130_fd_sc_hd__nor2_1 _6122_ (.A(_2385_),
    .B(_2386_),
    .Y(\core.u_fetch.next_pc[17] ));
 sky130_fd_sc_hd__xor2_1 _6123_ (.A(net344),
    .B(_2385_),
 ...
 sky130_fd_sc_hd__and2_1 _6127_ (.A(\core.inst_addr_out[20] ),
    .B(_2387_),
    .X(_2390_));
 sky130_fd_sc_hd__nor2_1 _6128_ (.A(net366),
    .B(_2387_),
    .Y(_2391_));
 sky130_fd_sc_hd__nor2_1 _6129_ (.A(_2390_),
    .B(_2391_),
    .Y(\core.u_fetch.next_pc[20] ));
 sky130_fd_sc_hd__xor2_1 _6130_ (.A(net357),
    .B(_2390_),
 ...
 sky130_fd_sc_hd__and2_1 _6134_ (.A(\core.inst_addr_out[23] ),
    .B(_2392_),
    .X(_2394_));
 sky130_fd_sc_hd__nor2_1 _6135_ (.A(net358),
    .B(_2392_),
    .Y(_2395_));
 sky130_fd_sc_hd__nor2_1 _6136_ (.A(_2394_),
    .B(_2395_),
    .Y(\core.u_fetch.next_pc[23] ));
 sky130_fd_sc_hd__xor2_1 _6137_ (.A(net351),
    .B(_2394_),
 ...
 sky130_fd_sc_hd__and2_1 _6141_ (.A(\core.inst_addr_out[26] ),
    .B(_2397_),
    .X(_2399_));
 sky130_fd_sc_hd__nor2_1 _6142_ (.A(net368),
    .B(_2397_),
    .Y(_2400_));
 sky130_fd_sc_hd__nor2_1 _6143_ (.A(_2399_),
    .B(_2400_),
    .Y(\core.u_fetch.next_pc[26] ));
 sky130_fd_sc_hd__xor2_1 _6144_ (.A(net340),
    .B(_2399_),
 ...
 sky130_fd_sc_hd__xor2_1 _6148_ (.A(net360),
    .B(_2401_),
 ...
 sky130_fd_sc_hd__xor2_1 _6152_ (.A(net339),
    .B(_2404_),
    .X(\core.u_fetch.next_pc[31] ));
 sky130_fd_sc_hd__or2_1 _6153_ (.A(net296),
    .B(\core.inst_addr_out[2] ),
    .X(_2406_));
 ...
 sky130_fd_sc_hd__and2_1 _6173_ (.A(net184),
    .B(net44),
    .X(_0019_));
 sky130_fd_sc_hd__and2_1 _6174_ (.A(net336),
    .B(net44),
    .X(_0020_));
 sky130_fd_sc_hd__and2_1 _6175_ (.A(net367),
    .B(net44),
    .X(_0021_));
 ...
 sky130_fd_sc_hd__and2_1 _6183_ (.A(\core.u_regfile.registers[1][29] ),
    .B(net45),
    .X(_0029_));
 sky130_fd_sc_hd__and2_1 _6184_ (.A(net354),
    .B(net44),
    .X(_0030_));
 sky130_fd_sc_hd__and2_1 _6185_ (.A(net337),
    .B(net44),
    .X(_0031_));
 ...
 sky130_fd_sc_hd__and2_1 _6215_ (.A(\core.u_regfile.registers[2][29] ),
    .B(net39),
    .X(_0061_));
 sky130_fd_sc_hd__and2_1 _6216_ (.A(net364),
    .B(net41),
    .X(_0062_));
 sky130_fd_sc_hd__and2_1 _6217_ (.A(net338),
    .B(net39),
    .X(_0063_));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout76 (.A(net77),
    .X(net76));
 sky130_fd_sc_hd__buf_6 fanout77 (.A(_2369_),
    .X(net77));
 ...
 sky130_fd_sc_hd__buf_1 fanout86 (.A(net87),
    .X(net86));
 sky130_fd_sc_hd__clkbuf_2 fanout87 (.A(net270),
    .X(net87));
 sky130_fd_sc_hd__buf_12 fanout88 (.A(net89),
    .X(net88));
 sky130_fd_sc_hd__buf_6 fanout89 (.A(_2096_),
    .X(net89));
 ...
 sky130_fd_sc_hd__buf_4 fanout165 (.A(net166),
    .X(net165));
 sky130_fd_sc_hd__buf_4 fanout166 (.A(\core.u_regfile.registers[2][4] ),
    .X(net166));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout174 (.A(net175),
    .X(net174));
 sky130_fd_sc_hd__buf_4 fanout175 (.A(\core.u_regfile.registers[2][0] ),
    .X(net175));
 sky130_fd_sc_hd__buf_2 fanout176 (.A(net177),
    .X(net176));
 sky130_fd_sc_hd__buf_2 fanout177 (.A(net178),
    .X(net177));
 sky130_fd_sc_hd__buf_2 fanout178 (.A(net320),
    .X(net178));
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout193 (.A(\core.u_regfile.registers[1][11] ),
    .X(net193));
 sky130_fd_sc_hd__buf_4 fanout194 (.A(\core.u_regfile.registers[1][7] ),
    .X(net194));
 sky130_fd_sc_hd__buf_4 fanout195 (.A(\core.u_regfile.registers[1][6] ),
    .X(net195));
 ...
 sky130_fd_sc_hd__buf_8 fanout214 (.A(net238),
    .X(net214));
 sky130_fd_sc_hd__buf_8 fanout215 (.A(net217),
    .X(net215));
 ...
 sky130_fd_sc_hd__buf_2 fanout236 (.A(net237),
    .X(net236));
 sky130_fd_sc_hd__clkbuf_4 fanout237 (.A(net304),
    .X(net237));
 ...
 sky130_fd_sc_hd__buf_1 rebuffer1 (.A(_2584_),
    .X(net256));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer2 (.A(_0103_),
    .X(net257));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer3 (.A(net264),
    .X(net258));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer4 (.A(_0204_),
    .X(net259));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer5 (.A(_0292_),
    .X(net260));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer6 (.A(_0180_),
    .X(net261));
 sky130_fd_sc_hd__clkbuf_2 rebuffer7 (.A(_0205_),
    .X(net262));
 sky130_fd_sc_hd__buf_6 rebuffer8 (.A(_2574_),
    .X(net263));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer9 (.A(_2575_),
    .X(net264));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer10 (.A(_2514_),
    .X(net265));
 sky130_fd_sc_hd__buf_6 rebuffer11 (.A(_2577_),
    .X(net266));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer12 (.A(_2513_),
    .X(net267));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer13 (.A(_0404_),
    .X(net268));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer14 (.A(_2475_),
    .X(net269));
 sky130_fd_sc_hd__buf_4 rebuffer15 (.A(net89),
    .X(net270));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer16 (.A(net270),
    .X(net271));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer17 (.A(net270),
    .X(net272));
 sky130_fd_sc_hd__dlymetal6s4s_1 rebuffer18 (.A(_2628_),
    .X(net273));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer19 (.A(_2571_),
    .X(net274));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer20 (.A(_2572_),
    .X(net275));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer21 (.A(_2486_),
    .X(net276));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer22 (.A(_2642_),
    .X(net277));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer23 (.A(net311),
    .X(net278));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer24 (.A(_0258_),
    .X(net279));
 sky130_fd_sc_hd__buf_6 rebuffer25 (.A(_2151_),
    .X(net280));
 sky130_fd_sc_hd__buf_1 rebuffer26 (.A(_0155_),
    .X(net281));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer27 (.A(_2426_),
    .X(net282));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer28 (.A(_2447_),
    .X(net283));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer29 (.A(net283),
    .X(net284));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer30 (.A(net283),
    .X(net285));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer31 (.A(_2433_),
    .X(net286));
 sky130_fd_sc_hd__buf_1 rebuffer32 (.A(_0210_),
    .X(net287));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer33 (.A(net317),
    .X(net288));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer34 (.A(net288),
    .X(net289));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer35 (.A(_2512_),
    .X(net290));
 sky130_fd_sc_hd__buf_6 rebuffer36 (.A(_2486_),
    .X(net291));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer37 (.A(_2238_),
    .X(net292));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer38 (.A(_2511_),
    .X(net293));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer39 (.A(_2438_),
    .X(net294));
 sky130_fd_sc_hd__buf_6 clone40 (.A(net217),
    .X(net295));
 sky130_fd_sc_hd__clkbuf_1 clone41 (.A(net217),
    .X(net296));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer42 (.A(_2449_),
    .X(net297));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer43 (.A(\core.u_regfile.registers[1][4] ),
    .X(net298));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer44 (.A(net298),
    .X(net299));
 sky130_fd_sc_hd__clkbuf_1 clone45 (.A(net220),
    .X(net300));
 sky130_fd_sc_hd__buf_4 rebuffer46 (.A(net105),
    .X(net301));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer47 (.A(_0156_),
    .X(net302));
 sky130_fd_sc_hd__buf_1 rebuffer48 (.A(_2466_),
    .X(net303));
 sky130_fd_sc_hd__buf_8 rebuffer49 (.A(net238),
    .X(net304));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer50 (.A(_0142_),
    .X(net305));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer51 (.A(_0145_),
    .X(net306));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer52 (.A(_3029_),
    .X(net307));
 sky130_fd_sc_hd__buf_1 rebuffer53 (.A(_2474_),
    .X(net308));
 sky130_fd_sc_hd__buf_6 rebuffer54 (.A(_2559_),
    .X(net309));
 sky130_fd_sc_hd__buf_1 rebuffer55 (.A(net219),
    .X(net310));
 sky130_fd_sc_hd__buf_1 rebuffer56 (.A(_2625_),
    .X(net311));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer57 (.A(\core.u_regfile.registers[2][4] ),
    .X(net312));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer58 (.A(net312),
    .X(net313));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer59 (.A(_2469_),
    .X(net314));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer60 (.A(_2408_),
    .X(net315));
 sky130_fd_sc_hd__clkbuf_1 clone61 (.A(net317),
    .X(net316));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer62 (.A(\core.u_regfile.registers[2][3] ),
    .X(net317));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer63 (.A(_2720_),
    .X(net318));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer64 (.A(_2471_),
    .X(net319));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer65 (.A(\core.u_regfile.registers[2][0] ),
    .X(net320));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer66 (.A(_2756_),
    .X(net321));
 sky130_fd_sc_hd__clkbuf_1 clone67 (.A(net219),
    .X(net322));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer71 (.A(_2895_),
    .X(net326));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer74 (.A(_2689_),
    .X(net329));
 sky130_fd_sc_hd__buf_6 rebuffer75 (.A(_2756_),
    .X(net330));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer76 (.A(_2786_),
    .X(net331));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer77 (.A(_2913_),
    .X(net332));
 sky130_fd_sc_hd__clkbuf_2 rebuffer78 (.A(_1828_),
    .X(net333));
 sky130_fd_sc_hd__dlygate4sd3_1 hold81 (.A(\core.u_regfile.registers[1][20] ),
    .X(net336));
 sky130_fd_sc_hd__dlygate4sd3_1 hold82 (.A(\core.u_regfile.registers[1][31] ),
    .X(net337));
 sky130_fd_sc_hd__dlygate4sd3_1 hold83 (.A(\core.u_regfile.registers[2][31] ),
    .X(net338));
 sky130_fd_sc_hd__dlygate4sd3_1 hold84 (.A(\core.inst_addr_out[31] ),
    .X(net339));
 sky130_fd_sc_hd__dlygate4sd3_1 hold85 (.A(\core.inst_addr_out[27] ),
    .X(net340));
 sky130_fd_sc_hd__dlygate4sd3_1 hold86 (.A(\core.inst_addr_out[15] ),
    .X(net341));
 sky130_fd_sc_hd__dlygate4sd3_1 hold87 (.A(\core.inst_addr_out[19] ),
    .X(net342));
 sky130_fd_sc_hd__dlygate4sd3_1 hold88 (.A(\core.inst_addr_out[22] ),
    .X(net343));
 sky130_fd_sc_hd__dlygate4sd3_1 hold89 (.A(\core.inst_addr_out[18] ),
    .X(net344));
 sky130_fd_sc_hd__dlygate4sd3_1 hold90 (.A(\core.inst_addr_out[9] ),
    .X(net345));
 sky130_fd_sc_hd__dlygate4sd3_1 hold91 (.A(\core.inst_addr_out[6] ),
    .X(net346));
 sky130_fd_sc_hd__dlygate4sd3_1 hold92 (.A(\core.inst_addr_out[10] ),
    .X(net347));
 sky130_fd_sc_hd__dlygate4sd3_1 hold93 (.A(\core.inst_addr_out[4] ),
    .X(net348));
 sky130_fd_sc_hd__dlygate4sd3_1 hold94 (.A(\core.inst_addr_out[7] ),
    .X(net349));
 sky130_fd_sc_hd__dlygate4sd3_1 hold95 (.A(\core.inst_addr_out[16] ),
    .X(net350));
 sky130_fd_sc_hd__dlygate4sd3_1 hold96 (.A(\core.inst_addr_out[24] ),
    .X(net351));
 sky130_fd_sc_hd__dlygate4sd3_1 hold97 (.A(\core.inst_addr_out[2] ),
    .X(net352));
 sky130_fd_sc_hd__dlygate4sd3_1 hold98 (.A(\core.inst_addr_out[12] ),
    .X(net353));
 sky130_fd_sc_hd__dlygate4sd3_1 hold99 (.A(\core.u_regfile.registers[1][30] ),
    .X(net354));
 sky130_fd_sc_hd__dlygate4sd3_1 hold100 (.A(\core.inst_addr_out[17] ),
    .X(net355));
 sky130_fd_sc_hd__dlygate4sd3_1 hold101 (.A(\core.inst_addr_out[14] ),
    .X(net356));
 sky130_fd_sc_hd__dlygate4sd3_1 hold102 (.A(\core.inst_addr_out[21] ),
    .X(net357));
 sky130_fd_sc_hd__dlygate4sd3_1 hold103 (.A(\core.inst_addr_out[23] ),
    .X(net358));
 sky130_fd_sc_hd__dlygate4sd3_1 hold104 (.A(\core.inst_addr_out[13] ),
    .X(net359));
 sky130_fd_sc_hd__dlygate4sd3_1 hold105 (.A(\core.inst_addr_out[29] ),
    .X(net360));
 sky130_fd_sc_hd__dlygate4sd3_1 hold106 (.A(\core.inst_addr_out[11] ),
    .X(net361));
 sky130_fd_sc_hd__dlygate4sd3_1 hold107 (.A(\core.inst_addr_out[8] ),
    .X(net362));
 sky130_fd_sc_hd__dlygate4sd3_1 hold108 (.A(\core.inst_addr_out[25] ),
    .X(net363));
 sky130_fd_sc_hd__dlygate4sd3_1 hold109 (.A(\core.u_regfile.registers[2][30] ),
    .X(net364));
 sky130_fd_sc_hd__dlygate4sd3_1 hold110 (.A(\core.inst_addr_out[5] ),
    .X(net365));
 sky130_fd_sc_hd__dlygate4sd3_1 hold111 (.A(\core.inst_addr_out[20] ),
    .X(net366));
 sky130_fd_sc_hd__dlygate4sd3_1 hold112 (.A(\core.u_regfile.registers[1][21] ),
    .X(net367));
 sky130_fd_sc_hd__dlygate4sd3_1 hold113 (.A(\core.inst_addr_out[26] ),
    .X(net368));
 sky130_fd_sc_hd__dlygate4sd3_1 hold114 (.A(\core.inst_addr_out[28] ),
    .X(net369));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_3 (.DIODE(\core.u_regfile.registers[2][16] ));
 sky130_fd_sc_hd__diode_2 ANTENNA_4 (.DIODE(net56));
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_9 (.DIODE(net189));
 sky130_fd_sc_hd__diode_2 ANTENNA_10 (.DIODE(net191));
 sky130_fd_sc_hd__diode_2 ANTENNA_11 (.DIODE(net198));
 sky130_fd_sc_hd__diode_2 ANTENNA_12 (.DIODE(net202));
 sky130_fd_sc_hd__diode_2 ANTENNA_13 (.DIODE(net205));
 sky130_fd_sc_hd__diode_2 ANTENNA_14 (.DIODE(net316));
 sky130_fd_sc_hd__diode_2 ANTENNA_15 (.DIODE(net34));
 sky130_fd_sc_hd__diode_2 ANTENNA_16 (.DIODE(net34));
 sky130_fd_sc_hd__diode_2 ANTENNA_17 (.DIODE(net191));
 ...
 sky130_fd_sc_hd__decap_6 FILLER_1_345 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_1_520 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_2_299 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_2_430 ();
 sky130_fd_sc_hd__fill_1 FILLER_2_436 ();
 sky130_fd_sc_hd__fill_1 FILLER_2_458 ();
 sky130_ef_sc_hd__decap_12 FILLER_2_490 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_3_596 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_5_471 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_6_631 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_7_173 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_7_530 ();
 sky130_fd_sc_hd__fill_1 FILLER_7_539 ();
 sky130_fd_sc_hd__decap_6 FILLER_7_546 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_8_442 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_8_605 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_9_327 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_10_464 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_10_577 ();
 sky130_fd_sc_hd__decap_6 FILLER_10_582 ();
 sky130_fd_sc_hd__fill_2 FILLER_10_596 ();
 sky130_fd_sc_hd__decap_6 FILLER_10_631 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_12_571 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_13_625 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_14_284 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_14_437 ();
 sky130_fd_sc_hd__decap_4 FILLER_14_449 ();
 sky130_fd_sc_hd__fill_1 FILLER_14_453 ();
 sky130_fd_sc_hd__decap_6 FILLER_14_503 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_14_566 ();
 sky130_ef_sc_hd__decap_12 FILLER_14_594 ();
 sky130_fd_sc_hd__decap_8 FILLER_14_606 ();
 sky130_ef_sc_hd__decap_12 FILLER_14_617 ();
 sky130_fd_sc_hd__decap_8 FILLER_14_629 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_15_543 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_15_624 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_18_624 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_19_423 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_19_610 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_20_630 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_21_360 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_22_620 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_26_630 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_28_49 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_29_479 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_30_630 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_31_581 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_36_64 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_36_324 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_38_346 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_40_68 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_46_441 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_48_577 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_49_121 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_50_602 ();
 sky130_fd_sc_hd__decap_4 FILLER_50_614 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_51_43 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_51_596 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_56_39 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_56_390 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_59_84 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_64_507 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_66_622 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_69_344 ();
 sky130_fd_sc_hd__fill_1 FILLER_69_350 ();
 sky130_ef_sc_hd__decap_12 FILLER_69_354 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_69_596 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_70_573 ();
 sky130_fd_sc_hd__fill_1 FILLER_70_599 ();
 sky130_fd_sc_hd__decap_8 FILLER_70_629 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_73_76 ();
 sky130_ef_sc_hd__decap_12 FILLER_73_88 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_76_46 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_83_159 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_85_485 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_88_161 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_90_52 ();
 sky130_fd_sc_hd__fill_1 FILLER_90_58 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_92_99 ();
 sky130_ef_sc_hd__decap_12 FILLER_92_111 ();
 sky130_ef_sc_hd__decap_12 FILLER_92_123 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_95_98 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_95_490 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_97_180 ();
 sky130_ef_sc_hd__decap_12 FILLER_97_192 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_98_183 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_99_161 ();
 sky130_ef_sc_hd__decap_12 FILLER_99_180 ();
 sky130_fd_sc_hd__decap_8 FILLER_99_192 ();
 sky130_fd_sc_hd__fill_2 FILLER_99_200 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_100_264 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_103_203 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_103_430 ();
 sky130_fd_sc_hd__fill_2 FILLER_103_438 ();
